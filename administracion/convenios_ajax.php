...
switch ($opcion) {
    ...
    case "2": //Imprime el formulario de crear nuevo convenio | actualizar convenio
        $parametro = $utilidades->str_decode($_POST["parametro"]);
        $accion_aux = "";
        $nombre = "";
		$cod_administradora = "";
        ...
        <form id="frmNuevoConvenio" name="frmNuevoConvenio">
                ...
                <fieldset style="">
                    ...
                    <table style="width: 100%; margin: auto; font-size: 10pt;">
                        ...
                        <tr>                         
                            ...
                            <td style="text-align:left;">
                            	<?php
                                	$lista_modalidades_contratacion = $dbListas->getListaDetalles(100);
                        ...
                        <tr>
                            ...
                            <td style="text-align:left;">
                                <label style="margin: 6px 0 0 0;">
                                    <input type="checkbox" name="indNumCarnetObl" id="indNumCarnetObl" <?php echo($indNumCarnetObl); ?> />
                                </label>
                            </td>
                        </tr>
                    </table>
            ...
            <br/>
            <input type="button" id="btnCancelarConvenio" nombre="btnCancelarConvenio" value="Cancelar" class="btnSecundario peq" onclick="muestra_convenios()"/> 
            <input type="submit" id="btnGuardarConvenio" nombre="btnGuardarConvenio" value="Guardar" class="btnPrincipal peq" onclick="guardaModificaConvenio(<?php echo $accion_aux; ?>)"/>
        </form>
    ...
    case "4": //Ventana Modal Agregar Planes
        ...
        if ($idPlan != 0) {
            ...
            //selecciona cual tipo de pago está seleccionado
            if ($tipoPago == "1") {
        ...
        <form id="frmAgregarPlan" name="frmAgregarPlan">
            <div style="width:98%; margin:auto;">
                <table style="width: 100%;">
                    ...
                    <tr>
                     ...
                     <tr>
                        ...
                        <td style="text-align:left; font-weight:600;">
                            <?php
								$lista_tipos_cobertura = $dbListas->getListaDetalles(99, 1);
                ...
                <input type="submit" id="btnGuardarConvenio" nombre="btnGuardarConvenio" value="<?php echo($valor_boton); ?>" class="btnPrincipal peq" onclick="agregar_plan(<?php echo $idPlan; ?>)"/>
            </div>
        </form>
    ...
    case "5": //Guarda el plan para el convenio
		...
		$rta_aux = $dbConvenios->crearModificarPlan($txtNombrePlan, $tipoPago, $indActivoPlan, $idConvenio, $id_usuario,
				...
				$indDescCC,$cmb_cobertura);
		?>
         <input type="hidden" id="hdd_resultado_plan" name="hdd_resultado_plan" value="<?= $rta_aux ?>" />
