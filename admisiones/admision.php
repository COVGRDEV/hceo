...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type="text/javascript" src="admision_v1.41.js"></script>
	...
	if (strlen(@$arr_cita_aux[0]) > 0) { //comprueba si lo recibido por post tiene caracteres
		...
		if (!isset($arr_cita_aux[2]) || $bol_adm_desde_cita) { //No existe id de la admisión
			...
			} else if ($cita_aux["id_estado_cita"] == "130") {
		...
		if (isset($arr_cita_aux[2])) { //Este es el id de la admision.
			...
			$cmb_zonificacion = $tabla_admision["id_detalle_zonificacion"];
                    ...
                    <form id="frmAdmision">
                        <div>
                            <div>
                                <fieldset style="">
                                    ...
                                    <table style="width:100%;">
                                        ...
                                        <tr>
                                            <td align="left">
                                                <?php $combo->getComboDb("cmb_tipo_id", $tipo_identificacion_aux, $dbListas->getTipodocumento(), "id_detalle, nombre_detalle", "Seleccione el tipo de documento", "", "", "width: 188px;"); ?>
                                            </td>
                                            <td align="left">
                                                <?php
                                        ...
                                        <tr>
                                            ...
                                            <td align="left">
                                                <?php $combo->getComboDb("cmb_tipo_sangre", $tipo_sangre, $dbListas->getListaDetalles(7), "id_detalle, nombre_detalle", "Seleccione el tipo de sangre", "", "", "width: 188px;", ""); ?>
                                            	</td>
                                            <td align="left">
                                                <?php $combo->getComboDb("cmb_factor_rh", $factor_rh, $dbListas->getListaDetalles(9), "id_detalle, nombre_detalle", "Seleccione el factor RH", "", "", "width: 188px;", ""); ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="left">
                                            ...
                                            <td align="left" id="td_departamento_nac_label">
                                                <label>Departamento de nacimiento*</label>
                                            </td>
                                            <td align="left" id="td_municipio_nac_label">
                                                <label>Municipio de nacimiento*</label>
                                            </td>
                                            <td align="left" id="td_departamento_nac_n_label" style="display:none;">
                                                <label>Estado / Provincia de nacimiento*</label>
                                            </td>
                                            <td align="left" id="td_municipio_nac_n_label" style="display:none;">
                                                <label>Municipio de nacimiento*</label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="left">
                                                <?php $combo->getComboDb("cmb_id_pais_nac", $pais_nac_aux == "" ? "1" : $pais_nac_aux, $dbPaises->getPaises(), "id_pais, nombre_pais", "Seleccione el pa&iacute;s", "seleccionar_pais(this.value, '_nac')", "", "width: 188px;"); ?>
                                                <?php
                                                	if ($pais_nac_aux != "" && $pais_nac_aux != "1") {
												?>
                                                <script id="ajax" type="text/javascript">
													seleccionar_pais("<?php echo($pais_nac_aux); ?>", "_nac");
												</script>
                                                <?php
													}
												?>
                                            </td>
                                            <td align="left" id="td_departamento_nac">
                                                <?php $combo->getComboDb("cmb_departamento_nac", $departamento_nac_aux, $dbDepartamentos->getDepartamentos(), "cod_dep, nom_dep", "Seleccione el departamento", "seleccionar_departamento(this.value, '', '_nac');", "", "width: 188px;"); ?>
                                            </td>
                                            <td align="left" id="td_municipio_nac">
                                                <div id="d_municipios_nac">
                                                    <?php $combo->getComboDb("cmb_municipio_nac", $municipio_nac_aux, $dbDepMuni->getMunicipiosDepartamento($departamento_nac_aux), "cod_mun_dane, nom_mun", "Seleccione el municipio", "", "", "width: 188px;"); ?>
                                                </div>
                                                <div id="d_municipio_reg" style="display:none;"></div>
                                            </td>
                                            <td align="left" id="td_departamento_nac_n" style="display:none;">
                                                <input type="text" id="txt_nombre_dep_nac" value="<?php echo($nombre_dep_nac_aux); ?>" onblur="trim_cadena(this);" />
                                            </td>
                                            <td align="left" id="td_municipio_nac_n" style="display:none;">
                                                <input type="text" id="txt_nombre_mun_nac" value="<?php echo($nombre_mun_nac_aux); ?>" onblur="trim_cadena(this);" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="left">
                                        ...
                                        <tr>
                                            <td align="left">
                                                <?php $combo->getComboDb("cmb_id_pais", $pais_aux == "" ? "1" : $pais_aux, $dbPaises->getPaises(), "id_pais, nombre_pais", "Seleccione el pa&iacute;s", "seleccionar_pais(this.value, '')", "", "width: 188px;"); ?>
                                                <?php
                                                	if ($pais_aux != "" && $pais_aux != "1") {
												?>
                                                <script id="ajax" type="text/javascript">
													seleccionar_pais("<?php echo($pais_aux); ?>", "");
												</script>
                                                <?php
													}
												?>
                                        ...
                                        <tr>
                                            ...
                                            <td align="left">
                                                <?php $combo->getComboDb("cmb_zona", $zona_aux, $dbListas->getListaZona(), "id_detalle, nombre_detalle", "Seleccione la zona", "", "", "width: 188px;"); ?>
                                            </td>
                                            <td align="left">
                                                <input type="text" id="txt_telefono" name="txt_telefono" value="<?php echo($telefono_aux); ?>" maxlength="20" />
                                            </td>
                                            <td align="left">
                                                <input type="text" id="txt_telefono2" name="txt_telefono2" value="<?php echo($telefono2_aux); ?>" maxlength="20" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="left">
                                        ...
                                        <tr>
                                            <td align="left">
                                                <input type="text" id="txt_email" name="txt_email" value="" />
                                            </td>
                                            <td align="left">
                                                <input type="text" id="txt_profesion" name="txt_profesion" value="<?php echo($profesion_aux); ?>" onblur="trim_cadena(this);" />
                                            </td>
                                            <td align="left">
                                                <?php $combo->getComboDb("cmb_estado_civil", $id_estado_civil_aux, $dbListas->getListaDetalles(40), "id_detalle, nombre_detalle", "Seleccione el estado civil", "", "", "width: 188px;"); ?>
                                            </td>
                                            <td align="left">
                                                <?php $combo->getComboDb("cmb_etnia", $etnia_aux, $dbListas->getListaEtnia(), "id_detalle, nombre_detalle", "Seleccione la etnia", "", "", "width: 188px;"); ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="left">
                                                <label>N&uacute;mero de hijos*</label>
                                            </td>
                                            <td align="left">
                                                <label>N&uacute;mero de hijas*</label>
                                            </td>
                                            <td align="left">
                                                <label>N&uacute;mero de hermanos*</label>
                                            </td>
                                            <td align="left">
                                                <label>N&uacute;mero de hermanas*</label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="left">
                                                <select id="cmb_numerohijos" name="cmb_numerohijos" class="select" style="width: 188px;">
                                                    <option value="">Seleccione</option>
                                                    <?php
	                                                    for ($i = 0; $i <= 25; $i++) {
															$selected_aux = "";
															if ($i == $numero_hijos_aux && $numero_hijos_aux !== "") {
                                            ...
                                            <td align="left">
                                                <select id="cmb_numerohijas" name="cmb_numerohijas" class="select" style="width: 188px;">
                                                    <option value="">Seleccione</option>
                                                    <?php
	                                                    for ($i = 0; $i <= 25; $i++) {
															$selected_aux = "";
															if ($i == $numero_hijas_aux && $numero_hijas_aux !== "") {
																$selected_aux = " selected=\"selected\"";
															}
                                                    ?>
                                                    <option value="<?php echo($i); ?>"<?php echo($selected_aux); ?>><?php echo($i); ?></option>
                                            ...
                                            <td align="left">
                                                <select id="cmb_numerohermanos" name="cmb_numerohermanos" class="select" style="width: 188px;">
                                                    <option value="">Seleccione</option>
                                                    <?php
                                                    	for ($i = 0; $i <= 25; $i++) {
															$selected_aux = "";
															if ($i == $numero_hermanos_aux && $numero_hermanos_aux !== "") {
																$selected_aux = " selected=\"selected\"";
															}
                                                    ?>
                                                    <option value="<?php echo($i); ?>"<?php echo($selected_aux); ?>><?php echo($i); ?></option>
                                            ...
                                            <td align="left">
                                                <select id="cmb_numerohermanas" name="cmb_numerohermanas" class="select" style="width: 188px;">
                                                    <option value="">Seleccione</option>
                                                    <?php
                                                    	for ($i = 0; $i <= 25; $i++) {
															$selected_aux = "";
															if ($i == $numero_hermanas_aux && $numero_hermanas_aux !== "") {
																$selected_aux = " selected=\"selected\"";
															}
                                                    ?>
                                                    <option value="<?php echo($i); ?>"<?php echo($selected_aux); ?>><?php echo($i); ?></option>
                                        ...
                                        <tr>
                                            <td align="left">
                                                <?php $combo->getComboDb("cmb_desplazado", $desplazado_aux, $dbListas->getListaDesplazado(), "id_detalle, nombre_detalle", "Seleccione el indicador", "", "", "width: 188px;"); ?>
                                            </td>
                                             <td align="left">
                                         ...
                                         <tr>
                                           <td style="display:none" id="tr_dispositivos">
                                           	<select onchange="abrirCamara();" style="width: 188px;" class="select" name="listaDeDispositivos" id="listaDeDispositivos">
                                            </select>
                                           </td>
                                           <td>
                            ...
                            <div>
                                <fieldset style="">
                                    ...
                                    <table style="width:100%;">
                                        ...
                                        <tr>
                                            <td align="left">
                                                <label>Nombre del acompa&ntilde;ante*</label>
                                            </td>
                                        	<td align="left">
                                            	<label>Observaciones de la cita</label>
                                            </td>
                                            <td align="left" id="td_presion_arterial_label"<?php if (!isset($tipo_cita_obj["ind_signos_vitales"]) || $tipo_cita_obj["ind_signos_vitales"] != "1") { ?> style="display:none;"<?php } ?>>
                                                <label>Presi&oacute;n arterial</label>
                                            </td>
                                            <td align="left" id="td_pulso_label"<?php if (!isset($tipo_cita_obj["ind_signos_vitales"]) || $tipo_cita_obj["ind_signos_vitales"] != "1") { ?> style="display:none;"<?php } ?>>
                                                <label>Pulso</label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="left">
                                                <input type="text" id="txt_acompanante" name="txt_acompanante" value="<?php echo($acompanante); ?>" onblur="trim_cadena(this);" />
                                            </td>
                                            <td align="left">
                                            	<label>
													<?php
                                            ...
                                            <td align="left" id="td_presion_arterial"<?php if (!isset($tipo_cita_obj["ind_signos_vitales"]) || $tipo_cita_obj["ind_signos_vitales"] != "1") { ?> style="display:none;"<?php } ?>>
                                                <input type="text" id="txt_presionarterial" name="txt_presionarterial" value="<?php echo($presionarterial); ?>" maxlength="7" />
                                            </td>
                                            <td align="left" id="td_pulso"<?php if (!isset($tipo_cita_obj["ind_signos_vitales"]) || $tipo_cita_obj["ind_signos_vitales"] != "1") { ?> style="display:none;"<?php } ?>>
                                                <input type="text" id="txt_pulso" name="txt_pulso" value="<?php echo($pulso); ?>" onkeypress="return solo_numeros(event, false);" maxlength="3" />
                                            </td>
                                        </tr>
                            	...
                            	<table border="0" style="width:100%;">
                                    ...
                                    <tr>
                                        ...
                                        <td align="left" style="width:21%;">
                                            ...
                                            <div id="d_convenio">
                                                <?php
													if (isset($arr_cita_aux[2])) { //Este es el id de la admision
														$combo->getComboDb("cmb_convenio", $id_convenio, $lista_convenios, "id_convenio, nombre_convenio", "Seleccione el Convenio", "seleccionar_convenio(".$plan.", ".$modificar_script.");", $modificar_valores, "width: 188px;");
													} else {
														$combo->getComboDb("cmb_convenio", isset($cita_aux["id_convenio"]) ? $cita_aux["id_convenio"] : 0, $lista_convenios, "id_convenio, nombre_convenio", "Seleccione el Convenio", "seleccionar_convenio(".$plan.", ".$modificar_script.");", $modificar_valores, "width: 188px;");	
													}
                                                ?>
                                            </div>
                                        </td>
                                        ...
                                        <td align="left" style="width:20%;">
                                            ...
                                            <script id="ajax">
												...
												seleccionar_convenio(<?php echo($plan); ?>, <?php echo($modificar_script); ?>);
											</script>
                                            <?php
												}
											?>
                                        ...
                                        <td align="right" style="width:13%;">
                                            <label class="inline">Medio de pago*:</label>
                                        </td>
                                        <td align="left" style="width:25%;">
                                            <?php
												//Se obtiene el listado de las opciones de medios de pago
												$lista_medios_pago = $dbListas->getListaDetalles(13);
												//var_dump($lista_medios_pago);
												
												foreach ($lista_medios_pago as $medio_aux) {
													if ($medio_aux["codigo_detalle"] == "99") {
											?>
                                            <input type="hidden" id="hdd_medio_pago_np" value="<?php echo($medio_aux["id_detalle"]); ?>" />
                                            <?php
														if ($cmb_medio_pago == "" && $ind_no_pago == "1") {
															$cmb_medio_pago = $medio_aux["id_detalle"];
														}
														break;
													}
												}
												
												$combo->getComboDb("cmb_medio_pago", $cmb_medio_pago, $lista_medios_pago, "id_detalle, nombre_detalle", "Seleccione el medio de pago", "seleccionar_medio_pago(this.value);", "", "width:188px;");
                                            ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td align="left">
                                        	<?php
												...
												$lista_tipos_usuario = $dbListas->getListaDetalles(101);
                                            	$combo->getComboDb("cmb_tipo_coti_paciente", $tipo_coti_paciente, $lista_tipos_usuario, "id_detalle, nombre_detalle", "Seleccione", "cargar_precios(".$modificar_script.", 0);", 1, "width: 188px;");
											?>
                                        ...
                                        <td align="left">
											...
											?>
                                        	 ...
                                        	 <?php
											 	/** Hacer visible o invisible el combo-box zonificacion**/
												
												$visible_zona_aux  = "none";
                                    			if ($convenio_aux["ind_eco"] == "1") {
													$visible_zona_aux  = "visible";
												}
											?>
                                          
                                            
                                        <td align="right" id="td_zonificacion_l" style="display:<?php echo($visible_zona_aux) ?>;" >
                                        	<label class="inline">Zonificación*:</label>
                                            
                                        </td>
                                        <td align="left" id="td_zonificacion" style="display:<?php echo($visible_zona_aux) ?>;">
                                        <input type="hidden" id="hdd_zonificacion_eco" value="<?php echo($convenio_aux["ind_eco"]); ?>" />
                                        	 <?php
											 	$lista_zonas_ecopetrol = $dbListas->getListaDetalles(83, 1);
																					
	                                    		$combo->getComboDb("cmb_zonificacion", $cmb_zonificacion, $lista_zonas_ecopetrol, "id_detalle, nombre_detalle", "Seleccione zonificación", "", 1, "width: 188px;");
											?>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left" id="td_num_mipress" style="display:<?php echo($visible_carnet_aux) ?>;">
                                         ...
                                         <td align="right" id="td_num_entrega_mipress_l" style="display:<?php echo($visible_carnet_aux) ?>;">
                                            <label class="inline">No. Entrega mipress:</label>
                                        </td>
                                        <td align="left" id="td_num_entrega_mipress" style="display:<?php echo($visible_carnet_aux) ?>;">
                                            <input style="width: 188px;" type="text" id="txt_num_entrega_mipress" name="txt_num_entrega_mipress"  value="" maxlength="20" onblur="trim_cadena(this);" />                 </td>
                                        
                                    </tr>   
                                    <tr>
                                    
                                    	<td align="right" id="td_num_poliza_l" style="display:<?php echo($visible_carnet_aux) ?>;">
                                            <label class="inline">No. Póliza:</label>
                                        </td>
                                        <td align="left" id="td_num_poliza" style="display:<?php echo($visible_carnet_aux) ?>;">
                                            <input style="width: 188px;" type="text" id="txt_num_poliza" name="txt_num_poliza"  value="" maxlength="20" onblur="trim_cadena(this);" />                 </td>
                                        
                                        <td  align="right">
                                        	<label class="inline">Prof. Formula*:</label>
                                        </td>
                                        <td align="left">
                                        	<?php
													$lista_profesionales_aux = $dbUsuarios->getProfesionalesPorPerfil("3");
													$combo->getComboDb("cmb_usuario_prof_formula".$contadorid_aux, $id_usuario_prof_formula, $lista_profesionales_aux, "id_usuario,profesional", "--Seleccione el profesional--", "seleccionarProfesional()",  1,  "width:188px;");
													
											?>
                                            
                                        </td>
                                        
                                         <td class="td_nombre_prof" align="right" style="display:none">
                                        	<label class="inline">Nombre Prof.*:</label>
                                        </td>
                                        <td class="td_nombre_prof" align="left" style="display:none">
                                             <input style="width: 188px;" type="text" id="txt_nombre_prof_formula" name="txt_nombre_prof_formula"  value="" />
                                        </td>
                                    ...
                                    <tr>
                                        <td colspan="6" style="text-align: center;">
                                            <div class="d_contenedor_precios" id="precios">
                                                <span><label class="inline">Precios</label></span>
                                            </div>
                                            <?php
												if (isset($arr_cita_aux[0])) { //Este es el id de la cita
											?>
                            ...
                            <div style="text-align: center; padding-top: 10px;">
								...
								?>
                                <input type="submit" id="btnNuevo" class="btnPrincipal" value="Guardar" onclick="guardar_admision();" />
                                <?php
									}
								?>
                            </div>
