	...
	switch ($opcion) {
        ...
        <?php
			if ($id_paciente_resul > 0) {
				...
				$tercero_obj = $id_tercero != "" ? $dbTerceros->getTercero($id_tercero) :  $dbPacientes->getExistepaciente3($id_paciente);
				...
				if ($id_tercero != "") {
					...
					$resultado_aux = $classClientesSIESA->crearTerceroClienteNoPaciente($id_tercero,$compania,$num_doc_tercero,
					$id_paciente,$id_lugar,"", $id_usuario, $num_doc_tercero);
					...
					$resultado_aux = $classClientesSIESA->crearTerceroClientePaciente($id_paciente,$compania,$num_doc_tercero,
					$id_paciente,$id_lugar,"",$id_usuario, $num_doc_tercero);
		...
		<?php
				...
				if ($resultado_aux == 1) {
					...
					$usuario_obj["numero_documento"], $id_paciente, $observaciones_anticipo, $arr_medios_pago, $id_usuario, $usuario_obj["id_usuario_siesa"]);
