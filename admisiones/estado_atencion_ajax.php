...
switch ($opcion) {
            ...
            <div id="d_datagrid" style="width: 925px; margin: auto;">
                ...
                <table class="paginated modal_table" style="width: 100%; margin: auto;">
                    ...
                    <tbody>
						...
						?>
                        <div style="color: #999;font-size: 13px;overflow: hidden;text-overflow: ellipsis;white-space: nowrap;">
									...
									switch ($id_estado_atencion) {
										case "1": //AGENDADOS
											if ($tipo_acceso_menu == "2") {
												$funcion_click = "confirmar_llegada_persona(".$value["id_cita"].", '".$nombre_completo_aux."', ".$value["id_lugar_cita"].", '".$value["nombre_lugar_cita"]."');";
											}
											break;
							...
							if ($estado_cita == $value["id_estado_cita"]) {
								...
								if ($tipo_acceso_menu == "2") {
									if ($id_estado_atencion == 1) {
										$funcion_click = "confirmar_llegada_persona(".$value["id_cita"].", '".$nombre_aux."', ".$value["id_lugar_cita"].", '".$value["nombre_lugar_cita"]."');";
									} else {
    ...
    <div id="dContenedorInterno">
        ...
        <table style="width:750px; margin:auto;" class="texto_subtitulo">   
            <tr>
                <td colspan="2">
                    <h6>Creado por: <?php echo($cita_obj["usuario_creador"]); ?></h6>
                </td>
                <td colspan="2">
            ...
            <tr>
                ...
                <td align="left" style="width:25%;"><b><?php echo $cita_obj["nombre_tipo_cita"]; ?></b></td>
            ...
            <tr>
                ...
                <td align="left"><b><?php echo $funcionesPersona->obtenerNombreCompleto($cita_obj["nombre_1"], $cita_obj["nombre_2"], $cita_obj["apellido_1"], $cita_obj["apellido_2"]) ?></b></td>
                <td align="right">Tel&eacute;fono de contacto:</td>
                <td align="left"><b><?php echo $cita_obj["telefono_contacto"]; ?></b></td>
            </tr>
            <tr>
            ...
            <tr>
				...
				?>
                <td align="left"><b><?php echo($texto_convenio); ?></b></td>
            ...
            <tr>
                <td style="text-align: justify;font-size: 12pt;" colspan="4">
                    <textarea style="height: 150px;" readonly="" rows="4" cols="50"><?php echo($cita_obj["observacion_cita"]); ?></textarea>
                </td>
            </tr>
            <tr>
                <td style="text-align: center;" colspan="4">
                    <input class="btnPrincipal" type="button" value="Registrar llegada" onclick="marcar_llegada_persona(<?php echo($id_cita); ?>)" />
                </td>
            </tr>
        </table>
        <?php
