    ...
    switch (id_estado_atencion) {
        ...
        case 3: //Iniciar consulta de optometría
            ...
            $("#d_interno").html('<table class="datagrid" border="0" cellpadding="5" cellspacing="0" align="center" style="width:100%"> ' +
                    ...
                    '<input type="button" id="btn_cancelar_si" nombre="btn_cancelar_si" value="Aceptar" class="btnPrincipal" onclick="enviar_formulario_consulta(' + id_admision + ', ' + id_paciente + ', ' + id_estado_atencion + ', \'' + pag_destino + '\',  \'' + nombre_paciente + '\');"/>&nbsp;&nbsp;' +
        ...
        case 4: //Consulta de optometría
            enviar_formulario_consulta(id_admision, id_paciente, id_estado_atencion, pag_destino, nombre_paciente);
            break;
        ...
        case 11: //Iniciar preconsulta
            ...
            $("#d_interno").html('<table class="datagrid" border="0" cellpadding="5" cellspacing="0" align="center" style="width:100%">' +
                    ...
                    '</h4></th></tr>' +
                    '<tr><th align="center" style="width:5%;border: 1px solid #fff;">' +
                    '<input type="button" id="btn_cancelar_si2" nombre="btn_cancelar_si2" value="Preconsulta" class="btnPrincipal" onclick="enviar_formulario_consulta(' + id_admision + ', ' + id_paciente + ', ' + id_estado_atencion + ', \'' + pag_destino + '?ind_preconsulta=1\',  \'' + nombre_paciente + '\');"/>&nbsp;&nbsp;' +
                    '<input type="button" id="btn_cancelar_si" nombre="btn_cancelar_si" value="Consulta" class="btnPrincipal" onclick="enviar_formulario_consulta(' + id_admision + ', ' + id_paciente + ', ' + id_estado_atencion + ', \'' + pag_destino + '\',  \'' + nombre_paciente + '\');"/>&nbsp;&nbsp;' +
                    '<input type="button" id="btn_cancelar_no" nombre="btn_cancelar_no" value="Cancelar" class="btnSecundario" onclick="cerrar_div_centro();"/>' +
                    '</th></tr></table>');
            $("#d_interno").css("height", "auto");
            break;
        case 12: //Preconsulta
            enviar_formulario_consulta(id_admision, id_paciente, id_estado_atencion, pag_destino + "?ind_preconsulta=1", nombre_paciente);
	        break;
...
function confirmar_llegada_persona(id_cita, nombre_persona, id_lugar_cita, nombre_lugar_cita) {
	var id_lugar_usuario = parseInt($("#hdd_lugar_usuario").val(), 10);
	
	if (id_lugar_cita == id_lugar_usuario) {
		continuar_confirmar_llegada_persona(id_cita);
	} else {
		$("#d_interno_adic").html(
			'<table border="0" cellpadding="5" cellspacing="0" align="center" style="width:100%">' +
				'<tr>' +
				...
				'<tr>' +
					'<th align="center">' +
						'<input type="button" id="btn_cancelar_si" nombre="btn_cancelar_si" class="btnPrincipal" value="Aceptar" onclick="continuar_confirmar_llegada_persona(' + id_cita + ');"/>\n' +
						'<input type="button" id="btn_cancelar_no" nombre="btn_cancelar_no" class="btnSecundario" value="Cancelar" onclick="cerrar_div_centro_adic();"/> ' +
					'</th>' +
				'</tr>' +
			'</table>');
...
function continuar_confirmar_llegada_persona(id_cita) {
	$("#d_centro_adic").css("height", "auto");
	$("#d_interno_adic").css("width", "100%");
	$("#d_interno_adic").css("height", "auto");
	
	$("#d_interno_adic").html("");
	var params = "opcion=6&id_cita=" + id_cita;
