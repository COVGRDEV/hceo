...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type='text/javascript' src='pacientes_v1.2.js'></script>
    </head>
    <body>
        <?php
        ...
        <div class="contenedor_principal">
            ...
            <div class="formulario" id="principal_historia_clinica" style="width: 100%; display: block; ">
                <table border="0" cellpadding="5" style="width: 100%;">
                    <tr>
                    	<td colspan="2"><h4>Buscar paciente</h4></td>
                    </tr>
                    <tr>
                        <td style="width:70%; text-align:right;">
                            <input type="text" id="txt_paciente_hc" placeholder="Buscar por nombre o documento del paciente" style="width:420px; float:right;" onblur="trim_cadena(this);" />
                        </td>
                        <td style="width:30%; text-align:left;">
                            <input type="button" id="btn_consultar" class="btnPrincipal peq" value="Buscar" onclick="buscar_paciente();" />
                        </td>
                    </tr>
                    <tr>
                    	<td colspan="2" valign="top"><div id="d_contenedor_paciente_hc" style="min-height: 30px;"></div></td>
                    </tr>
                </table>
