		...
		case "1": //Reporte general
			...
			if($diferencia_dias >= 34){
				...
				$objPHPExcel->getActiveSheet()
							...
							->setCellValue("B".$contador_linea, "TIEMPO OPTOMETRÍA EN MINUTOS")
							->setCellValue("C".$contador_linea, "TIEMPO PRE-CONSULTA EN MINUTOS")
							->setCellValue("D".$contador_linea, "TIEMPO EXAMENES EN MINUTOS")
							->setCellValue("E".$contador_linea, "TIEMPO OFTALMOLOGÍA EN MINUTOS")
							->setCellValue("F".$contador_linea, "SEDE")
							->setCellValue("G".$contador_linea, "TIPO DE DOCUMENTO")
							->setCellValue("H".$contador_linea, "NÚMERO DE DOCUMENTO")
							->setCellValue("I".$contador_linea, "PRIMER NOMBRE")
							->setCellValue("J".$contador_linea, "SEGUNDO NOMBRE")
							->setCellValue("K".$contador_linea, "PRIMER APELLIDO")
							->setCellValue("L".$contador_linea, "SEGUNDO APELLIDO")    	
							->setCellValue("M".$contador_linea, "NOMBRE DEL CONVENIO")
							->setCellValue("N".$contador_linea, "NOMBRE DEL PLAN");
				
				$objPHPExcel->getActiveSheet()->getStyle("A".$contador_linea.":N".$contador_linea)->getFont()->setBold(true);
				$contador_linea++;
				...
				foreach ($oport_aten as $datos_oportunidad_atencion) {
					...
					$objPHPExcel->getActiveSheet()
						...
						->setCellValue("C".$contador_linea, $datos_oportunidad_atencion["tiempo_precon"])
						->setCellValue("D".$contador_linea, $datos_oportunidad_atencion["tiempo_exa"])
						->setCellValue("E".$contador_linea, $datos_oportunidad_atencion["tiempo_oftan"])
						->setCellValue("F".$contador_linea,	$datos_oportunidad_atencion["sede"])
						->setCellValue("G".$contador_linea,	$datos_oportunidad_atencion["tipo_documento"])
						->setCellValue("H".$contador_linea,	$datos_oportunidad_atencion["numero_documento"])
						->setCellValue("I".$contador_linea,	$datos_oportunidad_atencion["nombre_1"])
						->setCellValue("J".$contador_linea,	$datos_oportunidad_atencion["nombre_2"])
						->setCellValue("K".$contador_linea,	$datos_oportunidad_atencion["apellido_1"])
						->setCellValue("L".$contador_linea,	$datos_oportunidad_atencion["apellido_2"])
						->setCellValue("M".$contador_linea,	$datos_oportunidad_atencion["nombre_convenio"])
						->setCellValue("N".$contador_linea,	$datos_oportunidad_atencion["nombre_plan"]);
