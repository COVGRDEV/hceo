<?php
	...
	//Define los metodos del servicio web
		...
		$pacientes = new DbPacientesClave();
		$resultados = $pacientes->getPacienteDetalle($id_paciente);
		return $resultados;
	}
	...
	function obtenerListaPreguntas() {
        ...
        function sincronizarRespuestas($cadena_datos_reg, $cadena_datos_res) {
		
		$arr_datos = array();
		$lista_datos = explode("|", $cadena_datos_res);
		...
		foreach ($lista_datos_reg as $cadena_aux_reg) {
			if ($cadena_aux_reg != "") {
				...
				$registro_aux_reg["nombre_paciente"] = $arr_aux_reg[1];
				$registro_aux_reg["cedula_paciente"] = $arr_aux_reg[2];
				$registro_aux_reg["id_ojo"] = $arr_aux_reg[3];
				$registro_aux_reg["id_paciente"] = $arr_aux_reg[4];
				$registro_aux_reg["fecha_respuesta"] = $arr_aux_reg[5];
				$registro_aux_reg["id_hc"] = $arr_aux_reg[6];
				$registro_aux_reg["fecha_hora_hc"] = $arr_aux_reg[7];
				$registro_aux_reg["id_seguimiento"] = $arr_aux_reg[8];
