...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type="text/javascript" src="asignar_citas_v1.13.js"></script>
            ...
            <div class="wrapper">
            	<?php
                	if ($ind_reasignar != 1) {
						if ($id_prog_cx == "") {
				?>
                <h3>Asignaci&oacute;n de citas</h3>
                <?php
						} else {
				...
				?>
                <h3 class="texto_resaltar">Reasignaci&oacute;n (<?php echo($funcionesPersona->obtenerNombreCompleto($cita_cancelar_obj["nombre_1"], "", $cita_cancelar_obj["apellido_1"], "")); ?>)</h3>
                <?php
					}
				?>
