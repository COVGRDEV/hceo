 ...
 */
            ...
            <div class="disponibilidad volumen">
        		<div class="encabezado">
           		...
           		<div class="listado-disponibilidad">
       				<ul>
						<?php
							$tabla_usuarios_citas = $dbAsignarCitas->getListaUsuariosCitas($id_usuario, 1);
					...
					for ($i = $minuto_ini_aux; $i <= $minuto_fin_aux; $i += 1) { //Teniendo la hora se recorre los minutos cada 1 para buscar las citas que tienen
						...
						<?php
							...
							foreach ($cita_hora as $fila_cita) {
								...
								$observacion_cita = $fila_cita["observacion_cita"];
	...
	case "3": //cargar el formulario de creacion y edicion de citas
		...
		if (isset($_POST["id_cita"])) {
			...
			$txt_primer_nombre = $tabla_cita["nombre_1"];
            $txt_segundo_nombre = $tabla_cita["nombre_2"];
            $txt_primer_apellido = $tabla_cita["apellido_1"];
            $txt_segundo_apellido = $tabla_cita["apellido_2"];
            $cmb_tipo_documento = $tabla_cita["id_tipo_documento"];
            $txt_numero_documento = $tabla_cita["numero_documento"];
            $txt_numero_telefono = $tabla_cita["telefono_contacto"];
			...
			if ($id_paciente != "") {
				...
				$txt_primer_nombre = $tabla_paciente["nombre_1"];
        	    $txt_segundo_nombre = $tabla_paciente["nombre_2"];
            	$txt_primer_apellido = $tabla_paciente["apellido_1"];
	            $txt_segundo_apellido = $tabla_paciente["apellido_2"];
    	        $cmb_tipo_documento = $tabla_paciente["id_tipo_documento"];
        	    $txt_numero_documento = $tabla_paciente["numero_documento"];
            	$txt_numero_telefono = $tabla_paciente["telefono_contacto"];
	            $cmb_convenio = $tabla_paciente["id_convenio"];
		...
		<form id="frm_citas" name="frm_citas" method="post">
            ...
            <table border="0" cellpadding="0" cellspacing="0" align="center" style="width:95%">
                ...
                <tr valign="top">
	                ...
	                <td align="left" style="width:32%;">
    		            ...
    		            if ($tipo_accion == 1) { //Para CREAR una cita
	            	        ...
	            	        $combo->getComboDb("cmb_tipo_cita", $id_tipo_cita, $lista_tipo_cita_usuario, "id_tipo_cita, nombre_tipo_cita, tiempo_tipo_cita, Minutos", "--Seleccione--", "cargar_horario(1, 0, 0); validar_lista_espera();", "", "width:100%;");
							if ($id_tipo_cita != "") {
						?>
                        <script id="ajax" type="text/javascript">
                ...
                <tr valign="top">
                    ...
                    <td align="left">
                        <?php
							...
							if ($ind_reasignar != 1) {
								$combo->getComboDb("cmb_tipo_documento", $cmb_tipo_documento, $lista_tipo_documento, "id_detalle, nombre_detalle", "--Seleccione--", "", "", "width:170px;");
							} else {
                    ...
                    <td align="left">
                    	<?php
                        	if ($ind_reasignar != 1) {
						?>
                        <input type="text" class="input required" value="<?php echo $txt_numero_documento;?>" name="txt_numero_documento" id="txt_numero_documento" maxlength="20" size="20" onblur="trim_cadena(this); quitar_espacios(this); validar_documento_cita(this.value, '<?php echo $tipo_accion; ?>', '<?php echo $id_cita; ?>', '<?php echo $fecha_cita;?>'); buscar_documento_paciente(this.value, <?php echo($id_lugar_disp); ?>); " />
                        <?php
							} else {
						?>
                ...
                <tr>
                    ...
                    <td align="left">
                    <?php if($sexo==""){ ?>
                        <select class="select" style="width:170px;" id="cmb_sexo" name="cmb_sexo" onchange="" tabindex=""><option class="dos" value="">--Seleccione--</option><option class="uno" value="1">Femenino</option><option class="dos" value="2">Masculino</option></select></td>
                   <?php }else if($sexo=="1"){ ?>
					   	<select class="select" style="width:170px;" id="cmb_sexo" name="cmb_sexo" onchange="" tabindex=""><option class="dos"
                        <option class="uno" value="1">Femenino</option><option class="dos" value="2">Masculino</option></select></td>
					<?php }else if($sexo=="2"){ ?>
                    	<select class="select" style="width:170px;" id="cmb_sexo" name="cmb_sexo" onchange="" tabindex=""><option class="dos"
                        <option class="dos" value="2">Masculino</option><option class="uno" value="1">Femenino</option></select></td>  
					<?php }?>
                </tr>
                <tr valign="top">
                    <td align="right">
                    ...
                    <td align="left">
                        <input type="text" class="input required" value="<?php echo $txt_numero_telefono;?>" name="txt_numero_telefono" id="txt_numero_telefono" maxlength="21" size="20" onkeypress="return solo_caracteres(event, '0123456789-');" />
                    </td>
                    ...
                    <td align="left">
                        <?php
							...
							$combo->getComboDb("cmb_convenio", $cmb_convenio, $lista_convenios, "id_convenio, nombre_convenio",  "--Seleccione--", "", "", "width:170px;");
						?>
                    </td>
                </tr>
                <tr valign="top">
                	<td align="right">
                        <label class="inline" for="cmb_tipo_cita"><b>Usa lentes&nbsp;</b></label>	
                    </td>
                    <td align="left">
                        <?php
							$combo->get("cmb_lentes", $cmb_lentes, $array_sino, "--Seleccione--", "", "", "width:170px;");
                        ?>
                    </td>
                    <td align="right">
                    	<label class="inline" for="cmb_tipo_cita"><b>No pago&nbsp;</b></label>	
                    </td>
                    <td align="left">
                    	<label class="inline">
	                    	<input type="checkbox" id="chk_no_pago" <?php if ($chk_no_pago == "1") { ?>checked="checked"<?php } ?> />
                        </label>
                    </td>
	            </tr>
	            <tr id="tr_espera_cx" valign="top" style="display:none;">
                	<td colspan="4">
                    	<div id="d_espera_cx" class="div_alerta_generica"></div>
                      	<input type="checkbox" id="chk_espera_si" onchange="controlar_checks_espera('si');" />
                        <label class="inline"><b>Si</b></label>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                      	<input type="checkbox" id="chk_espera_no" onchange="controlar_checks_espera('no');" />
                        <label class="inline"><b>No</b></label>
                    </td>
                </tr>
	            <tr valign="top">
	            	<td align="right">
					...
					<td align="left" colspan="3">
                    	<textarea name="txt_observacion_cita" id="txt_observacion_cita" class="textarea_ajustable" onblur="trim_cadena(this);" style="height:65px;"><?php echo($txt_observacion_cita); ?></textarea>
					</td>
	            </tr>
                <tr valign="top">
                   	<?php
	...
	case "5": //Crear nueva cita (incluye reasignación)
		...
		$tiempo_cita = $array_tiempo_cita["tiempo_tipo_cita"];
		$msg_resultado = $dbAsignarCitas->crearCita($txt_primer_nombre, $txt_segundo_nombre, $txt_primer_apellido, $txt_segundo_apellido,          $cmb_tipo_documento, $txt_numero_documento, $txt_numero_telefono, $cmb_convenio, $cmb_lentes, $txt_observacion_cita, $fecha_hora_cita,
		 $cmb_tipo_cita, $tiempo_cita, $hdd_id_usuario, $id_usuario_crea, $hdd_id_paciente, $hdd_lugar_disp, $ind_reasignar, $id_cita_reasignar, $chk_no_pago, $id_prog_cx, $sexo);
	...
	case "11": //Buscar persona de cita en pacientes y citas anteriores
		...
		if ($ind_cargar_datos) {
            ...
            <input type="hidden" name="hdd_id_convenio_pc" id="hdd_id_convenio_pc" value="<?php echo($id_convenio); ?>" />
             <input type="hidden" name="hdd_sexo_pc" id="hdd_sexo_pc" value="<?php echo($sexo); ?>" />
			<table border="0" cellpadding="5" cellspacing="0" align="center" style="width:98%;">
	           <tr>
	           	<th align="center">
                	<h4>Existe un paciente con este n&uacute;mero de documento:<br />
	           		<?php
	           			echo $documento." (".$nombre1." ".$nombre2." ".$apellido1." ".$apellido2.")";
	           		?>
	           		,<br/>&iquest;Desea cargar estos datos al formulario?</h4></th>
	           </tr>
	           <tr>
	           	<th align="center" style="width:5%">
	           		<input type="button" id="btn_cancelar_si" nombre="btn_cancelar_si" value="Si" onclick="cargar_datos_paciente(); validar_lista_espera();" class="btnPrincipal" />
