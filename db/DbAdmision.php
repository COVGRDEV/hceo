...
class DbAdmision extends DbConexion {
    public function CrearEditarAdmision($in_nombre_1, $in_nombre_2, $in_apellido_1, $in_apellido_2, $in_id_tipo_documento, $in_numero_documento,
			...
			$cmb_medio_pago, $post, $cmbprofesionalAtiende, $cmb_profesionalFormula, $nombre_profesional, $arr_usuarios_citas_det, $arr_examenes, $in_id_usuario_crea,
			$hdd_id_admision_paciente, $hdd_estado_consulta, $in_id_estado_civil, $in_num_carnet, $tipo_coti_paciente, $rango_paciente,$foto_paciente,
			$num_mipress,$num_ent_mipress, $num_poliza,$cmb_zonificacion){
		...
		if ($resultado_aux > 0) {
			...
			$resultado_out=-208;			
			$in_ind_desplazado == 'NULL' ? "NULL" : $in_ind_desplazado;
			$in_id_etnia == 'NULL' ? "NULL" : $in_id_etnia;
			$in_cod_dep_nac == 'NULL' ? $in_cod_dep_nac = "NULL" : $in_cod_dep_nac = "'".$in_cod_dep_nac."'";
			$in_cod_mun_nac == 'NULL' ? $in_cod_mun_nac = "NULL" : $in_cod_mun_nac = "'".$in_cod_mun_nac."'";
			$in_nom_dep_nac == 'NULL' ? $in_nom_dep_nac = "NULL" : $in_nom_dep_nac = "'".$in_nom_dep_nac."'";
			$in_nom_mun_nac == 'NULL' ? $in_nom_mun_nac = "NULL" : $in_nom_mun_nac = "'".$in_nom_mun_nac."'";
			$in_cod_dep == 'NULL' ? $in_cod_dep = "NULL" : $in_cod_dep = "'".$in_cod_dep."'";
			$in_cod_mun == 'NULL' ? $in_cod_mun = "NULL" : $in_cod_mun = "'".$in_cod_mun."'";
			$in_nom_dep == 'NULL' ? $in_nom_dep = "NULL" : $in_nom_dep = "'".$in_nom_dep."'";
			$in_nom_mun == 'NULL' ? $in_nom_mun = "NULL" : $in_nom_mun = "'".$in_nom_mun."'";
			...
			$cmbprofesionalAtiende == 'NULL' ? $cmbprofesionalAtiende = 0 : $cmbprofesionalAtiende = "".$cmbprofesionalAtiende."";
			$cmb_profesionalFormula == 'NULL' ? $cmbprofesionalAtiende = 0 : $cmb_profesionalFormula = "".$cmb_profesionalFormula."";
			$in_presion_arterial == 'NULL' ? $in_presion_arterial = "NULL" : $in_presion_arterial = "'".$in_presion_arterial."'";
			$in_txt_nombre_cirugia == 'NULL' ? $in_txt_nombre_cirugia = "NULL" : $in_txt_nombre_cirugia = "'".$in_txt_nombre_cirugia."'";
			$in_txt_fecha_cirugia == 'NULL' ? $in_txt_fecha_cirugia = "NULL" : $in_txt_fecha_cirugia = "STR_TO_DATE('".$in_txt_fecha_cirugia."', '%d/%m/%Y')";
			$in_txt_nombre_med_orden == 'NULL' ? $in_txt_nombre_med_orden = "NULL" : $in_txt_nombre_med_orden = "'".$in_txt_nombre_med_orden."'";
			$in_id_estado_civil == "" ? $in_id_estado_civil = "NULL" : $in_id_estado_civil = "".$in_id_estado_civil;
			$in_num_carnet == 'NULL' ? $in_num_carnet = "NULL" : $in_num_carnet = "'".$in_num_carnet."'";
			
			$num_mipress == 'NULL' ? $num_mipress = "NULL" : $num_mipress = "'".$num_mipress."'";
			$num_ent_mipress == 'NULL' ? $num_ent_mipress = "NULL" : $num_ent_mipress = "'".$num_ent_mipress."'";
			$num_poliza == 'NULL' ? $num_poliza = "NULL" : $num_poliza = "'".$num_poliza."'";
			$cmb_zonificacion == "" ? $cmb_zonificacion = "NULL" : $cmb_zonificacion = "".$cmb_zonificacion;
			
			$nombre_profesional == 'NULL' ? $nombre_profesional = "NULL" : $nombre_profesional = "'".$nombre_profesional."'";
			...
			try {
				...
				if ($hdd_id_admision_paciente > 0) {
					$sql = "CALL pa_editar_admision('".$in_nombre_1."', ".$in_nombre_2.", '".$in_apellido_1."', ".$in_apellido_2.", ".$in_id_tipo_documento.", '".
					   ...
					   $in_numero_hermanas.", ".$in_nombre_acompa.", ".$cmb_convenio.", '".$txtprofesion."', ".$txtmconsulta.", ".$txt_observaciones_admision.", ".$cmb_medio_pago.", ".$post.", ".$cmbprofesionalAtiende.", ".$cmb_profesionalFormula.", ".$nombre_profesional.", 
					   ".$in_id_estado_civil.", ".$in_id_usuario_crea.", ".$hdd_id_admision_paciente.", ".
					   $hdd_estado_consulta.", ".$in_num_carnet.", ".$tipo_coti_paciente.", ".$rango_paciente.",".$cmb_zonificacion.", '".$foto_paciente."', ".$num_mipress.",
					   ".$num_ent_mipress.", ".$num_poliza.", @id)";
				} else {
					$sql = "CALL pa_crear_admision('".$in_nombre_1."', ".$in_nombre_2.", '".$in_apellido_1."', ".$in_apellido_2.", ".$in_id_tipo_documento.", '".
					   ...
					   $cmb_medio_pago.", ".$post.", ".$cmbprofesionalAtiende.", ".$cmb_profesionalFormula.", ".$nombre_profesional.",
					    ".$in_id_estado_civil.", ".$in_num_carnet.", ".$tipo_coti_paciente.", ".
					   $rango_paciente.",'".$foto_paciente."',".$cmb_zonificacion.", ".$in_id_usuario_crea.", ".$num_mipress.", ".$num_ent_mipress.", ".$num_poliza.", @id)";
}				
...
public function CrearEditarDatosMercadeo($cmb_lista_merc, $cmb_subcategoria_merc, $txt_remitido_merc, $txt_otro_merc,$txt_referido_merc, $rta_aux){
		
			$cmb_lista_merc == 'NULL' ? "NULL" : $cmb_lista_merc;
			$cmb_subcategoria_merc == 'NULL' ? $cmb_subcategoria_merc = "NULL" : $cmb_subcategoria_merc = "'".$cmb_subcategoria_merc."'";
			$txt_remitido_merc == 'NULL' ? $txt_remitido_merc = "NULL" : $txt_remitido_merc = "'".$txt_remitido_merc."'";
			$txt_otro_merc == 'NULL' || $txt_otro_merc =="" ? $txt_otro_merc = "NULL" : $txt_otro_merc = "'".$txt_otro_merc."'";
			$txt_referido_merc == 'NULL' || $txt_referido_merc == "" ? $txt_referido_merc = "NULL" : $txt_referido_merc = "'".$txt_referido_merc."'";
			
		try{
			$sql = "CALL pa_crear_mercadeo_datos(".$cmb_lista_merc.",".$cmb_subcategoria_merc.", ".$txt_remitido_merc.", ".$txt_otro_merc.", ".$txt_referido_merc.", ".$rta_aux.", @id)";
    ...
    public function guardarTemporalPagosDetalle($idUsuario, $idListaPrecios, $idConvenio, $idPlan, $numAutorizacion, $tipoBilateral, $cantidad, $tipoPrecio, $valor, 		                                                $indTipoPago,$valorCuota = "0", $cod_procedimiento = "", $cod_medicamento = "", $cod_insumo = "", $cod_insumo_siesa="") {
	    ...
	    try {
			...
			if ($cod_insumo_siesa == "") {
				$cod_insumo_siesa = "NULL";
			}else{
				$cod_insumo_siesa = "'".$cod_insumo_siesa."'";
			}
			if($idListaPrecios == ""){
				$idListaPrecios = "NULL";
			}
			...
			$sql = "CALL pa_guardar_temporal_pagos_detalle(".$idUsuario.", ".$idListaPrecios.", ".$idConvenio.", ".$idPlan.", ".
					...
					$cod_procedimiento.", ".$cod_medicamento.", ".$cod_insumo.",".$cod_insumo_siesa.", @id)";
			echo($sql);
			$arrCampos[0] = "@id";
			$arrResultado = $this->ejecutarSentencia($sql, $arrCampos);
			$resultado_out = $arrResultado["@id"];
    ...
    public function get_admision($id_admision) {
        try {
            $sql = "SELECT A.*, C.observacion_cita, DATE_FORMAT(A.fecha_cirugia, '%d/%m/%Y') AS fecha_cirugia_t,
					...
					DZ.nombre_detalle AS zonificacion
					FROM admisiones A
					...
					LEFT JOIN listas_detalle DZ ON DZ.id_detalle=A.id_detalle_zonificacion
	...
	*/
    public function get_ultima_admision_tiempo($id_paciente, $unidad, $num_unidades) {
        try {
            ...
            $sql = "SELECT A.*, FM.id_formulario_mercadeo AS formulario_mercadeo, FM.categoria, FM.subcategoria, FM.remitido, FM.otro, FM.referido, C.observacion_cita, DATE_FORMAT(A.fecha_cirugia, '%d/%m/%Y') AS fecha_cirugia_t,
					...
					LEFT JOIN citas C ON A.id_cita=C.id_cita
					LEFT JOIN listas_detalle O ON A.id_ojo=O.id_detalle
					LEFT JOIN formulario_mercadeo FM ON FM.id_admision= A.id_admision
					WHERE A.id_paciente=".$id_paciente."
					".$sqlAux."
					ORDER BY fecha_admision DESC
					LIMIT 1";
	...
	public function getMercadeo($fechaInicial, $fechaFinal, $id_plan, $id_convenio,  $id_mercadeo, $id_lugar) {
		try{
			$sql = "SELECT DATE_FORMAT(A.fecha_admision, '%d/%m/%Y') AS fecha_admision_t,LG.nombre_detalle AS sede, P.numero_documento, P.nombre_1, P.nombre_2, P.apellido_1, 		                    P.apellido_2, P.email, P.telefono_1, P.telefono_2, P.profesion, fu_calcular_edad(P.fecha_nacimiento,CURDATE()) AS edad,P.direccion, P.id_pais,PS.nombre_pais AS 								                    pais, DP.nom_dep ,CD.nom_mun , P.nom_dep AS nom_dep_tex, P.nom_mun AS nom_mun_tex , CV.nombre_convenio, PL.nombre_plan, CONCAT(UP.nombre_usuario, ' ', 						                    UP.apellido_usuario) AS nombre_usuario_prof, TC.nombre_tipo_cita, SX.nombre_detalle AS genero, EC.nombre_detalle AS estado_civil, ZN.nombre_detalle AS                    zona,DV.nombre_detalle AS desplazado, FM.*, LS.nombre_lista AS nom_categoria, SC.nombre_detalle AS nom_subcategoria, P.ind_habeas_data
                    ...
                    INNER JOIN listas_detalle ZN ON P.id_zona = ZN.id_detalle 
                    INNER JOIN listas_detalle DV ON P.ind_desplazado = DV.id_detalle 
	...
	try{
			...
			$sql = "SELECT A.id_admision, TC.nombre_tipo_cita, T34.fecha_inicial_opt, T34.fecha_final_opt, 
					ABS(TIMESTAMPDIFF(MINUTE,T34.fecha_inicial_opt,T34.fecha_final_opt))AS tiempo_opt, T56.fecha_inicial_oftan, T56.fecha_final_oftan, 
					ABS(TIMESTAMPDIFF(MINUTE,T56.fecha_inicial_oftan,T56.fecha_final_oftan))AS tiempo_oftan, T116.fecha_inicial_pre, T116.fecha_final_pre,
					ABS(TIMESTAMPDIFF(MINUTE,T116.fecha_inicial_pre,T116.fecha_final_pre))AS tiempo_precon, T1314.fecha_inicial_exa, T1314.fecha_final_exa, 
					ABS(TIMESTAMPDIFF(MINUTE,T1314.fecha_inicial_exa,T1314.fecha_final_exa))AS tiempo_exa, 
					LG.id_detalle AS id_sede, LG.nombre_detalle AS sede, TD.nombre_detalle AS tipo_documento,
					P.numero_documento, P.nombre_1, P.nombre_2, P.apellido_1, P.apellido_2, CV.nombre_convenio, CV.id_convenio, PL.nombre_plan, PL.id_plan
					FROM admisiones A 
					INNER JOIN pacientes P ON A.id_paciente= P.id_paciente 
					...
					LEFT JOIN (
						SELECT A.id_admision, TI.fecha_estado AS fecha_inicial_pre, MIN(TF.fecha_estado) AS fecha_final_pre
						FROM admisiones A 
						INNER JOIN admisiones_estados_tiempos TI ON A.id_admision=TI.id_admision
						INNER JOIN admisiones_estados_tiempos T2 ON A.id_admision=T2.id_admision
						INNER JOIN admisiones_estados_tiempos TF ON A.id_admision=TF.id_admision AND T2.id_adm_est_tiempo < TF.id_adm_est_tiempo
						WHERE A.fecha_admision BETWEEN STR_TO_DATE('".$fechaInicial." 00:00:00', '%Y-%m-%d %H:%i:%s') AND STR_TO_DATE('".$fechaFinal." 23:59:59', '%Y-%m-%d %H:%i:%s')
						AND TI.id_estado_atencion=11
						AND T2.id_estado_atencion=6
						GROUP BY A.id_admision, TI.fecha_estado
					) T116 ON A.id_admision=T116.id_admision
					LEFT JOIN(
						SELECT A.id_admision, TI.fecha_estado AS fecha_inicial_exa, MIN(TF.fecha_estado) AS fecha_final_exa
						FROM admisiones A 
						INNER JOIN admisiones_estados_tiempos TI ON A.id_admision=TI.id_admision
						INNER JOIN admisiones_estados_tiempos T2 ON A.id_admision=T2.id_admision
						INNER JOIN admisiones_estados_tiempos TF ON A.id_admision=TF.id_admision AND T2.id_adm_est_tiempo < TF.id_adm_est_tiempo
						WHERE A.fecha_admision BETWEEN STR_TO_DATE('".$fechaInicial." 00:00:00', '%Y-%m-%d %H:%i:%s') AND STR_TO_DATE('".$fechaFinal." 23:59:59', '%Y-%m-%d %H:%i:%s')
						AND TI.id_estado_atencion=13
						AND T2.id_estado_atencion=14
						GROUP BY A.id_admision, TI.fecha_estado
					)T1314 ON A.id_admision=T1314.id_admision
					LEFT JOIN (
