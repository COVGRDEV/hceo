<?php
	...
	class DbConsultaOftalmologia extends DbHistoriaClinica {
		...
		public function EditarConsultaOftalmologia($id_hc, $hdd_id_admision, $enfermedad_actual, $muscular_balance, $muscular_motilidad, $muscular_ppc,
				...
				$tratamiento_oftalmo, $array_antecedentes_medicos_ids, $array_antecedentes_medicos_val, $img_biomiocroscopia, $img_tonometria_od,
				$img_tonometria_oi, $tipo_guardar, $id_usuario_crea, $desc_antecedentes_medicos, $observaciones_gonioscopia, $medicamentos_oftalmo,
				...
				$ind_eval_muscular, $mapa_hc_listas_rec, $ind_antec_cx_refrac) {
			try {
				//Para tonometria
					...
					for ($i = 0; $i <= count($array_antecedentes_medicos_ids) - 1; $i++) {
						...
						if ($val_medicos==1) {
							$sql = "INSERT INTO temporal_antecedentes
									...
									VALUES (".$id_hc.", ".$id_usuario_crea.", 1, ".$array_antecedentes_medicos_ids[$i].", ".$val_medicos.")";
				...
				$sql = "CALL pa_editar_consultas_oftalmologia(".$id_hc.", ".$hdd_id_admision.", '".$enfermedad_actual."', '".$muscular_balance."', '".
						...
						$img_tonometria_od."', '".$img_tonometria_oi."', '".$desc_antecedentes_medicos."', '".$observaciones_gonioscopia."', '".$medicamentos_oftalmo."', ".
						$nombre_usuario_alt.", ".$nombre_usuario_preconsulta.", '".$observaciones_tonometria."', ".$ind_formula_gafas.", ".$ind_eval_muscular.", ".
						$ind_antec_cx_refrac.", ".$tipo_guardar.", ".$id_usuario_crea.", @id)";
