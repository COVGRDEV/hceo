...
class DbDisponibilidadProf extends DbConexion {
    public function crearDisponibilidadProf($id_usuario_prof, $fecha_cal, $id_tipo_disponibilidad, $id_lugar_disp,
			$hora_ini, $hora_fin, $lugar_disp_d, $hora_ini2, $hora_fin2, $lugar_disp_d2, $id_usuario_crea) {
