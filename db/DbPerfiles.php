<?php
	...
	class DbPerfiles extends DbConexion {
		 ...
		 */
		public function crearPerfil($nombre_perfil, $descripcion, $ind_atiende, $ind_citas, $ind_cirugia, $id_menu_inicio,
				$id_usuario, $menus_permisos, $ind_modificar_pagos = "0", $ind_registrar_pagos = "0") {
			try {
		 ...
		 */
		public function editarPerfil($id_perfil, $nombre_perfil, $descripcion, $ind_atiende, $ind_citas, $ind_cirugia,
				$id_menu_inicio, $ind_activo, $id_usuario, $menus_permisos, $ind_modificar_pagos = "0", $ind_registrar_pagos = "0") {
			try {
				if (trim($id_menu_inicio) == "") {
					$id_menu_inicio = "NULL";
				}
				$sql = "CALL pa_editar_perfil(".$id_perfil.", '".$nombre_perfil."', '".$descripcion."', ".$ind_atiende.", ".$ind_citas.", ".
						$ind_cirugia.", ".$id_menu_inicio.", ".$ind_modificar_pagos.", ".$ind_registrar_pagos.", ".$ind_activo.", ".$id_usuario.", @id)";
