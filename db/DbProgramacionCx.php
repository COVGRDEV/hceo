	...
	class DbProgramacionCx extends DbConexion {
		...
		*/
		...
		public function getListaProgramacionCxFechas($fecha_ini, $fecha_fin, $tipo_fecha, $tipo_concepto, $cod_concepto, $id_usuario_prof, $lista_estados_prog) {
			try {
				$sql = "SELECT DISTINCT PC.*, TD.codigo_detalle AS cod_tipo_documento, TD.nombre_detalle AS tipo_documento, 
				        P.numero_documento, P.nombre_1, P.nombre_2,
						P.apellido_1, P.apellido_2, P.telefono_1, P.telefono_2,P.ind_habeas_data, P.email, 
						UP.nombre_usuario AS nombre_usuario_prof, UP.apellido_usuario AS apellido_usuario_prof,EP.nombre_detalle AS estado_prog, 
						C.nombre_convenio, DATE_FORMAT(PC.fecha_prog, '%d/%m/%Y') AS fecha_prog_t, DATE_FORMAT(PC.fecha_prog, '%h:%i %p') AS hora_prog_t, 
