	...
	class DbTerceros extends DbConexion {
		...
		public function crear_tercero($id_tipo_documento, $numero_documento, $numero_verificacion, $nombre_tercero,
			...
			try {
				...
				$sql = "CALL pa_crear_tercero(".$id_tipo_documento.", '".$numero_documento."', ".$numero_verificacion.", '".$nombre_tercero."', ".$nombre_1.", ".$nombre_2.", ".$apellido_1.", ".$apellido_2.", '".$email."', ".$id_paciente.", ".$ind_activo.", ".$id_usuario.",  ".$obligaciones.",  ".$det_tributarios.",".$ind_iva.",  @id)";
