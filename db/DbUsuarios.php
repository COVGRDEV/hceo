<?php
	...
	class DbUsuarios extends DbConexion {
		...
		public function getProfesionalesPorPerfil($perfil){
			try{
				
				$sql="SELECT *, CONCAT(U.nombre_usuario, ' ', U.apellido_usuario) AS profesional
			         FROM usuarios U 
		...
		public function crearUsuario($nombre_usuario, $apellido_usuario, $id_tipo_documento, $numero_documento, $id_usuario_firma,
				$id_tipo_num_reg, $num_reg_medico, $reg_firma, $login_usuario, $clave_usuario, $ind_anonimo, $ind_autoriza, $perfiles_usuarios, $id_usuario_crea) {
			try {
				if ($id_usuario_firma == "") {
		...
		public function editarUsuario($id_usuario, $nombre_usuario, $apellido_usuario, $id_tipo_documento, $numero_documento, $id_usuario_firma,
				$id_tipo_num_reg, $num_reg_medico, $reg_firma, $ind_anonimo, $ind_activo, $perfiles_usuarios, $id_usuario_crea, $ind_autoriza) {
			try {
				$array_perfiles_usuarios = explode(",", $perfiles_usuarios);
