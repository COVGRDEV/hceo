<?php
	...
	class Class_Pedidos_Siesa {
		...
		public function crearEntidadPedidoDocumento($compania,$cod_prestador, $co_ventas, $bodega_ventas, $id_pago, $num_pedido,$id_usuario, $id_convenio, $id_plan,$id_paciente) {
			$classConectorSiesa = new Class_Conector_Siesa();
			$classConsultasSiesa = new Class_Consultas_Siesa();
			$dbPagos = new DbPagos();
		...
		public function crearEntidadPedido($compania, $co_ventas, $bodega_ventas, $id_pago, $num_pedido,$id_usuario) {
			$classConectorSiesa = new Class_Conector_Siesa();
			$classConsultasSiesa = new Class_Consultas_Siesa();
			$dbPagos = new DbPagos();
			$dbAdmision = new DbAdmision();
			...
			foreach ($lista_pagos_detalle as $detalle_aux) {
				...
				switch ($detalle_aux["tipo_precio"]) {
					...
					case "M":
						...
						break;
					case "I":
						$cod_servicio = $detalle_aux["cod_insumo_siesa"];
						break;
				}
