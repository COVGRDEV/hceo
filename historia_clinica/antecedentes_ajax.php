<?php session_start();
	...
	switch ($opcion) {
		...
		case "2": //Formulario de detalle de antecedentes
			@$indice = $utilidades->str_decode($_POST["indice"]);
			@$tipo_extension = $utilidades->str_decode($_POST["tipo_extension"]);
			
			obtener_antecedente_detalle($indice, $tipo_extension, array());
			break;
	}
?>
