...
function ver_historia_clinica($id_paciente, $nombre_persona, $documento_persona, $tipo_documento, $telefonos, $fecha_nacimiento, $edad_paciente) {
    ...
    <fieldset style="width: 90%; margin: auto;">
		...
		?>
        <br/>
        <table id="lista_encuestas_postqx" class="paginated modal_table" style="width: 100%;  margin: auto;">
        	<thead>
				...
				*/
				...
				if($id_ojo==1){
					...
					<tr>
						...
						<?php
						if($valor_imagen == 'SIN FOTO'){
						?>
						<td align="center" > <?php echo $valor_imagen; ?></td>
						<?php	
						}
						else{
						?>
						<!-- <td align="center" onclick='mostrar_foto("<?php echo($valor_imagen); ?>")' ><img src="<?php echo $valor_imagen; ?>" height="100" width="100"></td> -->
						<td align="center"><img src="<?php echo $valor_imagen; ?>" height="100" width="100"></td>
						<?php	
						}
						?>
		...
		<script id='ajax'>
			//<![CDATA[ 
			$(function() {
			    $('#lista_encuestas_postqx', 'table').each(function(i) {
			        $(this).text(i + 1);
			    });
			
			    $('#lista_encuestas_postqx').each(function() {
			        var currentPage = 0;
			        var numPerPage = 10;
			        var $table = $(this);
    ...
    case "1": //Consultar HC del paciente	
        ...
        if ($cantidad_datos == 1) {//Si se encontro un solo registro
            ...
            <script id='ajax'>
                ...
                $(function() {
                    $('#tabla_persona_hc', 'table').each(function(i) {
                        $(this).text(i + 1);
                    });

                    $('#tabla_persona_hc').each(function() {
                        var currentPage = 0;
                        var numPerPage = 5;
                        var $table = $(this);
                        $table.bind('repaginate', function() {
