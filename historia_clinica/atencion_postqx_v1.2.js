...
function ver_registros_hc(id_persona, nombre_persona, documento_persona, tipo_documento, telefonos, fecha_nacimiento, edad_paciente) {
	...
	//llamarAjax("atencion_postqx_ajax.php", params, "contenedor_paciente_hc", "");
	llamarAjax("atencion_postqx_ajax.php", params, "d_interno_postqx", "mostrar_formulario_flotante_postqx(1)");
...
function validar_exito() {
	...
	setTimeout("cerrar_div_centro_postqx()", 3000);
...
function mostrar_formulario_flotante_postqx(tipo) {
    if (tipo == 1) { //mostrar
        $('#fondo_negro_postqx').css('display', 'block');
        $('#d_centro_postqx').slideDown(400).css('display', 'block');
    } else if (tipo == 0) { //Ocultar
        $('#fondo_negro_postqx').css('display', 'none');
        $('#d_centro_postqx').slideDown(400).css('display', 'none');
    }
}


function cerrar_div_centro_postqx() {
    $("#fondo_negro_postqx").css("display", "none");
    $("#d_centro_postqx").css("display", "none");
}
