...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type="text/javascript" src="consulta_control_laser_of_v1.12.js"></script>
        <?php
			$lista_si_no = array();
			$lista_si_no[0]["id"] = "1";
    ...
    <body>
                    ...
                    <div class="tabs-container">
                        <dl class="tabs" data-tab>
                            ...
                            <dd id="panel_oft_1" onclick="ajustar_div_optometria();"><a href="#panel2-1">Optometr&iacute;a</a></dd>
                             <dd id="panel_oft_3" onclick="ajustar_div_optometria();"><a href="#panel2-3">Incapacidad</a></dd>
                        </dl>
       ...
       <script>
			...
			initCKEditorControl("txt_observaciones_adicionales");
       </script>
    	<?php
		   if(!isset($_POST["tipo_entrada"])){
