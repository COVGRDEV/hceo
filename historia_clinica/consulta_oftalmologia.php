...
<html xmlns="http://www.w3.org/1999/xhtml"><head>
    ...
    <script type="text/javascript" src="consulta_oftalmologia_v1.31.js"></script>
...
<body onload="ajustar_textareas(); ocultar_panels_oftalmologia();">
	<?php
		...
		if (isset($_POST["hdd_id_paciente"])) {
			...
			if (count($tabla_hc) > 0) { //Si se encuentra una HC para este paciente se carga los datos de lo contrario se crea la HC
				...
				$desc_antecedentes_medicos = $tabla_oftalmologia["desc_antecedentes_medicos"];
				$ind_antec_cx_refrac = $tabla_oftalmologia["ind_antec_cx_refrac"];
		...
		$tabla_antecedentes_medicos = $dbConsultaOftalmologia->getAntecedentesMedicos($id_hc_consulta, 1, "");
		//Obtener el listado de los antecedentes otros
		$tabla_antecedentes_otros = $dbConsultaOftalmologia->getAntecedentesOtros($id_hc_consulta, 1, "");
    ...
    <div class="tabs-container">
		<dl class="tabs" data-tab>
		    <dd id="panel_oft_2" class="active"><a href="#panel2-2" onclick="setTimeout(function() { ajustar_textareas(); }, 100);">Enf. actual y antecedentes</a></dd>
		    ...
		    <dd id="panel_oft_3"><a href="#panel2-3" onclick="setTimeout(function() { ajustar_textareas(); }, 100);">Motilidad y seg. anterior</a></dd>
            <?php
				$display_aux = "none";
				if ($tipo_reg_adicional == "1" || $ind_eval_muscular == "1") {
					$display_aux = "block";
			...
			?>
            <dd id="panel_oft_6" style="display:<?php echo($display_aux); ?>;"><a href="#panel2-6" onclick="setTimeout(function() { ajustar_textareas(); }, 100);">Eval. muscular y sensorialidad</a></dd>
		    <dd id="panel_oft_4"><a href="#panel2-4" onclick="setTimeout(function() { ajustar_textareas(); }, 100);">Fondo de ojo</a></dd>
		    <dd id="panel_oft_5"><a href="#panel2-5" onclick="setTimeout(function() { ajustar_textareas(); }, 100);">Diagn&oacute;stico</a></dd>
            <dd id="panel_oft_8"><a href="#panel2-8" onclick="setTimeout(function() { ajustar_textareas(); }, 100);">Incapacidades</a></dd>
		</dl>
		   		...
		   		<td align="left" colspan="3">
		   			<table border="0" cellpadding="3" cellspacing="0" align="center" style="width:100%;">	
                        ...
                        <tr>
							...
							if($id_hc >= "443440" && strpos(trim(strip_tags($solicitud_examenes),""),substr($mensaje_HC["valor_variable"], 0, 10)) === 0  || ($id_hc < "443440" && $id_hc > 0) || ($id_hc == 0 && strpos(trim(strip_tags($solicitud_examenes),""),substr($mensaje_HC["valor_variable"], 0, 10)) === 0)){
							?>		
							...
							?>
                                <div id="txt_solicitud_examenes"><?php echo("<b>".$mensaje_HC["valor_variable"]."</b>"."<br><br>".$utilidades->ajustar_texto_wysiwyg($solicitud_examenes)) ?></div>
                            <?php 
							}
							?>  
                            </td>
   ...
   <script type="text/javascript">
		...
		initCKEditorOftalmo("txt_desc_antecedentes_medicos");
