...
function editar_consulta_oftalmologia(tipo) {
    ...
    var cant_sistemas_rev = parseInt($("#hdd_cant_sistemas_rev").val(), 10);
	params += "&cant_sistemas_rev=" + cant_sistemas_rev;
    for (var i = 0; i < cant_sistemas_rev; i++) {
		params += "&id_sistema_rev_" + i + "=" + $("#hdd_id_sistema_rev_" + i).val() +
				  "&revision_sistema_rev_" + i + "=" + str_encode(eval("CKEDITOR.instances.txt_sistemas_rev_" + i + ".getData()"));
	}
