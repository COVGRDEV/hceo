...
function validar_oftalmologia() {
	...
	$("#nombre_usuario_preconsulta").css({"border": "1px solid rgba(0,0,0,.2)"});
	
	$("#cmb_formula_gafas").css({"border": "1px solid rgba(0,0,0,.2)"});
	...
	if ($("#cmb_formula_gafas").val() == "" && $("#hdd_ind_optometria").val() == "1") {
		$("#cmb_formula_gafas").css({"border": "2px solid #FF002A"});
		result = 1;
		panel_5 = 1;
	}
	...
	if ($("#hdd_ind_preconsulta_n").val() == "1" && $('#nombre_usuario_preconsulta').val() == "") {
		$("#nombre_usuario_preconsulta").css({"border": "2px solid #FF002A"});
		result = 1;
	}
