...
<head>
    ...
    <script type='text/javascript' src='consulta_optometria_v1.33.js'></script>
    <?php
	...
	<div class="contenedor_principal" id="id_contenedor_principal">
        ...
        <div class="formulario" id="principal_optometria" style="width: 100%; display: block; ">
			...
			<form id='frm_consulta_optometria' name='frm_consulta_optometria' method="post">
				...
				<table border="0" cellpadding="0" cellspacing="4" align="center" style="width:98%;">				
					<tr>
						<th align="left" valign="top" style="width:16%;"><h6 style="margin: 1px;"><b>Alternativa que desea:</b></h6></th>
						<td align="left" valign="top" style="width:29%;">
							<input id="alternativa_anteojos" type="checkbox" style="margin:1px;" <?php echo($alternativa_anteojos);?> /><label for="alternativa_anteojos">Anteojos</label>
							<input id="alternativa_lc" type="checkbox" style="margin:1px;" onclick="comprobar_lc_alternativa();" <?php echo($alternativa_lc);?> /><label for="alternativa_lc">LdC</label>
							<input id="alternativa_refractiva" type="checkbox" style="margin:1px;" <?php echo($alternativa_refractiva);?> /><label for="alternativa_refractiva">Cx Refractiva</label>
						</td>
						<td align="left" valign="top" style="width:4%;"><label>Otra:&nbsp;</label></td>
						<td align="left" style="width:51%;">
							<textarea class="textarea_op_obs" id="alternativa_otra" nombre="alternativa_otra" style="width: 100%;" onblur="trim_cadena(this);" ><?php echo($alternativa_otra);?></textarea>
							<script>
								$("#alternativa_otra").textareaAutoSize();
								arr_textarea_ids.push("alternativa_otra");
							</script>
						</td> 
						<!--<td align="left" valign="top" style="width:4%;">
							<h6 style="margin: 1px;"><b>Ojo:</b></h6>
						</td>
						<td align="left" valign="top" style="width:11%;">
							<?php
								/*if ($id_ojo == "") {
									$id_ojo = "81";
								}
								$combo->getComboDb("cmb_ojo_optometria", $id_ojo, $lista_ojos, "id_detalle, nombre_detalle", "", "seleccionar_ojo_op(this.value);", true, '', '', 'select_hc componente_color_pick_'.$arr_colores[2]);
								$colorPick->getColorPick("cmb_ojo_optometria", 2);*/
							?>
						</td>-->
					</tr>
					<tr id="tr_alternativa_lc" <?php if ($alternativa_lc != "checked") { ?>style="display:none;"<?php } ?>>
						<td align="center" colspan="6">
							<h5 class="texto_resaltar"><b>No dilatar; hacer primero prescripción de lentes de contacto y despu&eacute;s del examen oftalmol&oacute;gico dilatar.</b></h5>
						</td>
					</tr>
					<tr>
                ...
                <!--SE AÑADE EL MENSAJE DE HC -->	
                    <tr>
						<td align="center" class="">
							...
							<?php
							$id_hc = $_POST['hdd_id_hc'];
							is_null($id_hc) ? $id_hc = 0 : $id_hc;
												 
						    if($id_hc >= "443440" && strpos(trim(strip_tags($txt_observaciones_optometria),""),substr($mensaje_HC["valor_variable"], 0, 10)) === 0  || ($id_hc < "443440" && $id_hc > 0) || ($id_hc == 0 && strpos(trim(strip_tags($txt_observaciones_optometria),""),substr($mensaje_HC["valor_variable"], 0, 10)) === 0)){
							?>		
							...
							?>
                                <div id="txt_observaciones_optometria"><?php echo("<b>".$mensaje_HC["valor_variable"]."</b>"."<br><br>".$utilidades->ajustar_texto_wysiwyg($txt_observaciones_optometria)) ?></div>
                            <?php 
							}
							?>     	
