 ...
 */
	...
	switch ($opcion) {
		case "1": //Guardar Consulta de Optometria
			...
			$alternativa_anteojos = $_POST["alternativa_anteojos"]; 
			$alternativa_lc = $_POST["alternativa_lc"]; 
			$alternativa_refractiva = $_POST["alternativa_refractiva"]; 
			$alternativa_otra = $utilidades->str_decode($_POST['alternativa_otra']);
			...
			$ind_opt = $dbConsultaOptometria->EditarConsultaOptometria($hdd_id_hc_consulta, $hdd_id_admision, $txt_anamnesis,
					...
					$txt_observaciones_subjetivo, $txt_observaciones_rxfinal, $cmb_validar_consulta, $cmb_examinado_antes, $rx_anteojos,
