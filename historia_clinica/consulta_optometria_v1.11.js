...
var initCKEditorLenso = (function() {
	var wysiwygareaAvailable = isWysiwygareaAvailable(),
		isBBCodeBuiltIn = !!CKEDITOR.plugins.get('bbcode');
	
	return function() {
		var editorElement = CKEDITOR.document.getById('txt_observaciones_lensometria');
		
		//Dependiendo de la disponibilidad del plugin wysiwygare se incia el editor clásico o el editor en línea.
		if (wysiwygareaAvailable) {
			CKEDITOR.replace('txt_observaciones_lensometria');
		} else {
			editorElement.setAttribute('contenteditable', 'true');
			CKEDITOR.inline('txt_observaciones_lensometria');
		}
	};
...
var initCKEditorObjetivo = (function() {
	var wysiwygareaAvailable = isWysiwygareaAvailable(),
		isBBCodeBuiltIn = !!CKEDITOR.plugins.get('bbcode');
	
	return function() {
		var editorElement = CKEDITOR.document.getById('txt_observaciones_objetivo');
		
		//Dependiendo de la disponibilidad del plugin wysiwygare se incia el editor clásico o el editor en línea.
		if (wysiwygareaAvailable) {
			CKEDITOR.replace('txt_observaciones_objetivo');
		} else {
			editorElement.setAttribute('contenteditable', 'true');
			CKEDITOR.inline('txt_observaciones_objetivo');
		}
	};
...
var initCKEditorCiclo = (function() {
	var wysiwygareaAvailable = isWysiwygareaAvailable(),
		isBBCodeBuiltIn = !!CKEDITOR.plugins.get('bbcode');
	
	return function() {
		var editorElement = CKEDITOR.document.getById('txt_observaciones_cicloplejia');
		
		//Dependiendo de la disponibilidad del plugin wysiwygare se incia el editor clásico o el editor en línea.
		if (wysiwygareaAvailable) {
			CKEDITOR.replace('txt_observaciones_cicloplejia');
		} else {
			editorElement.setAttribute('contenteditable', 'true');
			CKEDITOR.inline('txt_observaciones_cicloplejia');
		}
	};
...
var initCKEditorRxFinal2 = (function() {
	var wysiwygareaAvailable = isWysiwygareaAvailable(),
		isBBCodeBuiltIn = !!CKEDITOR.plugins.get('bbcode');
	
	return function() {
		var editorElement = CKEDITOR.document.getById('txt_observaciones_rxfinal_2');
		
		//Dependiendo de la disponibilidad del plugin wysiwygare se incia el editor clásico o el editor en línea.
		if (wysiwygareaAvailable) {
			CKEDITOR.replace('txt_observaciones_rxfinal_2');
		} else {
			editorElement.setAttribute('contenteditable', 'true');
			CKEDITOR.inline('txt_observaciones_rxfinal_2');
		}
	};
...
var initCKEditorPIN = (function() {
	var wysiwygareaAvailable = isWysiwygareaAvailable(),
		isBBCodeBuiltIn = !!CKEDITOR.plugins.get('bbcode');
	
	return function() {
		var editorElement = CKEDITOR.document.getById('txt_observaciones_pin');
		
		//Dependiendo de la disponibilidad del plugin wysiwygare se incia el editor clásico o el editor en línea.
		if (wysiwygareaAvailable) {
			CKEDITOR.replace('txt_observaciones_pin');
		} else {
			editorElement.setAttribute('contenteditable', 'true');
			CKEDITOR.inline('txt_observaciones_pin');
		}
	};
...
var initCKEditorRevFinal = (function() {
	var wysiwygareaAvailable = isWysiwygareaAvailable(),
		isBBCodeBuiltIn = !!CKEDITOR.plugins.get('bbcode');
	
	return function() {
		var editorElement = CKEDITOR.document.getById('txt_observaciones_optometricas_finales');
		
		//Dependiendo de la disponibilidad del plugin wysiwygare se incia el editor clásico o el editor en línea.
		if (wysiwygareaAvailable) {
			CKEDITOR.replace('txt_observaciones_optometricas_finales');
		} else {
			editorElement.setAttribute('contenteditable', 'true');
			CKEDITOR.inline('txt_observaciones_optometricas_finales');
		}
	};
...
function validar_optometria() {
	...
	if ($('#querato_ejek2_od').val() == '' && $('#querato_ejek2_od').attr("disabled") != "disabled" && $('#querato_k2_od').val() != g_querato_np) {
	...
	if ($('#querato_ejek2_oi').val() == '' && $('#querato_ejek2_oi').attr("disabled") != "disabled" && $('#querato_k2_oi').val() != g_querato_np) {
...
function seleccionar_ojo_op(id_ojo) {
	switch (id_ojo) {
		case "79":
			...
			$("#cicloplejio_cerca_od").removeAttr("disabled");
			...
			$("#cicloplejio_cerca_oi").attr("disabled", "disabled");
		...
		case "80":
			...
			$("#cicloplejio_cerca_od").attr("disabled", "disabled");
			...
			$("#cicloplejio_cerca_oi").removeAttr("disabled");
