...
function validar_optometria() {
	...
	$("#txt_anamnesis").css({"border": "1px solid rgba(0,0,0,.2)"});
	$("#avsc_lejos_od").css({"border": "1px solid rgba(0,0,0,.2)"});
	
	$("#avsc_cerca_od").css({"border": "1px solid rgba(0,0,0,.2)"});
	$("#avsc_lejos_oi").css({"border": "1px solid rgba(0,0,0,.2)"});
	
	$("#avsc_cerca_oi").css({"border": "1px solid rgba(0,0,0,.2)"});
	$("#querato_k1_od").css({"border": "1px solid rgba(0,0,0,.2)"});
	$("#querato_ejek1_od").css({"border": "1px solid rgba(0,0,0,.2)"});
	$("#querato_k2_od").css({"border": "1px solid rgba(0,0,0,.2)"});
	$("#querato_ejek2_od").css({"border": "1px solid rgba(0,0,0,.2)"});
	$("#querato_dif_od").css({"border": "1px solid rgba(0,0,0,.2)"});
	$("#querato_k1_oi").css({"border": "1px solid rgba(0,0,0,.2)"});
	$("#querato_ejek1_oi").css({"border": "1px solid rgba(0,0,0,.2)"});
	$("#querato_k2_oi").css({"border": "1px solid rgba(0,0,0,.2)"});
	$("#querato_ejek2_oi").css({"border": "1px solid rgba(0,0,0,.2)"});
	$("#querato_dif_oi").css({"border": "1px solid rgba(0,0,0,.2)"});
	
	$("#subjetivo_esfera_od").css({"border": "1px solid rgba(0,0,0,.2)"});
	
	$("#subjetivo_lejos_od").css({"border": "1px solid rgba(0,0,0,.2)"});
	
	$("#subjetivo_cerca_od").css({"border": "1px solid rgba(0,0,0,.2)"});
	$("#subjetivo_esfera_oi").css({"border": "1px solid rgba(0,0,0,.2)"});
	
	$("#subjetivo_lejos_oi").css({"border": "1px solid rgba(0,0,0,.2)"});
	
	$("#subjetivo_cerca_oi").css({"border": "1px solid rgba(0,0,0,.2)"});
	$("#refrafinal_esfera_od").css({"border": "1px solid rgba(0,0,0,.2)"});
	
	$("#refrafinal_esfera_oi").css({"border": "1px solid rgba(0,0,0,.2)"});
	
	
	$("#cmb_grado_satisfaccion").css({"border": "1px solid rgba(0,0,0,.2)"});
	...
	if($('#txt_anamnesis').val()==''){
		$("#txt_anamnesis").css({"border": "2px solid #FF002A"});
		result=1;
		panel_1=1;
	}
	if($('#avsc_lejos_od').val()==''){
		$("#avsc_lejos_od").css({"border": "2px solid #FF002A"});
		result=1;
		panel_2=1;
	}
	
	if($('#avsc_cerca_od').val()==''){
		$("#avsc_cerca_od").css({"border": "2px solid #FF002A"});
		result=1;
		panel_2=1;
	}
	if($('#avsc_lejos_oi').val()==''){
		$("#avsc_lejos_oi").css({"border": "2px solid #FF002A"});
		result=1;
		panel_2=1;
	}
	
	if($('#avsc_cerca_oi').val()==''){
		$("#avsc_cerca_oi").css({"border": "2px solid #FF002A"});
		result=1;
		panel_2=1;
	}
	if($('#querato_k1_od').val()==''){
		$("#querato_k1_od").css({"border": "2px solid #FF002A"});
		result=1;
		panel_3=1;
	}
	if($('#querato_ejek1_od').val()==''){
		$("#querato_ejek1_od").css({"border": "2px solid #FF002A"});
		result=1;
		panel_3=1;
	}
	if($('#querato_k2_od').val()==''){
		$("#querato_k2_od").css({"border": "2px solid #FF002A"});
		result=1;
		panel_3=1;
	}
	if($('#querato_ejek2_od').val()==''){
		$("#querato_ejek2_od").css({"border": "2px solid #FF002A"});
		result=1;
		panel_3=1;
	}
	if($('#querato_dif_od').val()==''){
		$("#querato_dif_od").css({"border": "2px solid #FF002A"});
		result=1;
		panel_3=1;
	}
	if($('#querato_k1_oi').val()==''){
		$("#querato_k1_oi").css({"border": "2px solid #FF002A"});
		result=1;
		panel_3=1;
	}
	if($('#querato_ejek1_oi').val()==''){
		$("#querato_ejek1_oi").css({"border": "2px solid #FF002A"});
		result=1;
		panel_3=1;
	}
	if($('#querato_k2_oi').val()==''){
		$("#querato_k2_oi").css({"border": "2px solid #FF002A"});
		result=1;
		panel_3=1;
	}
	if($('#querato_ejek2_oi').val()==''){
		$("#querato_ejek2_oi").css({"border": "2px solid #FF002A"});
		result=1;
		panel_3=1;
	}
	if($('#querato_dif_oi').val()==''){
		$("#querato_dif_oi").css({"border": "2px solid #FF002A"});
		result=1;
		panel_3=1;
	}
	
	if($('#subjetivo_esfera_od').val()==''){
		$("#subjetivo_esfera_od").css({"border": "2px solid #FF002A"});
		result=1;
		panel_4=1;
	}
	
	if($('#subjetivo_lejos_od').val()==''){
		$("#subjetivo_lejos_od").css({"border": "2px solid #FF002A"});
		result=1;
		panel_4=1;
	}
	
	if($('#subjetivo_cerca_od').val()==''){
		$("#subjetivo_cerca_od").css({"border": "2px solid #FF002A"});
		result=1;
		panel_4=1;
	}
	if($('#subjetivo_esfera_oi').val()==''){
		$("#subjetivo_esfera_oi").css({"border": "2px solid #FF002A"});
		result=1;
		panel_4=1;
	}
	
	if($('#subjetivo_lejos_oi').val()==''){
		$("#subjetivo_lejos_oi").css({"border": "2px solid #FF002A"});
		result=1;
		panel_4=1;
	}
	
	if($('#subjetivo_cerca_oi').val()==''){
		$("#subjetivo_cerca_oi").css({"border": "2px solid #FF002A"});
		result=1;
		panel_4=1;
	}
	if($('#refrafinal_esfera_od').val()==''){
		$("#refrafinal_esfera_od").css({"border": "2px solid #FF002A"});
		result=1;
		panel_5=1;
	}
	
	if($('#refrafinal_esfera_oi').val()==''){
		$("#refrafinal_esfera_oi").css({"border": "2px solid #FF002A"});
		result=1;
		panel_5=1;
	}
	
	if($('#cmb_grado_satisfaccion').val()==''){
		$("#cmb_grado_satisfaccion").css({"border": "2px solid #FF002A"});
		result=1;
		panel_5=1;
	}
...
function validar_crear_optometria(tipo, ind_imprimir) {
	...
	switch (tipo) {
		...
		// Permite que la consulta se guarde finalizada sin validar campos llenos
			 
			$("#frm_consulta_optometria").validate({
...
function editar_consulta_optometria(tipo){
	...
	var txt_anamnesis = str_encode($('#txt_anamnesis').val());
	...
	var querato_k2_od = $('#querato_k2_od').val();
	var querato_ejek2_od = $('#querato_ejek2_od').val();
	var querato_dif_od = $('#querato_dif_od').val();
	var querato_k1_oi = $('#querato_k1_oi').val();
	var querato_ejek1_oi = $('#querato_ejek1_oi').val();
	var querato_k2_oi = $('#querato_k2_oi').val();
	var querato_ejek2_oi = $('#querato_ejek2_oi').val();
	...
	var cicloplejio_cerca_od = $('#cicloplejio_cerca_od').val();
	...
	var cicloplejio_cerca_oi = $('#cicloplejio_cerca_oi').val();
	...
	var txt_observaciones_subjetivo = str_encode($('#txt_observaciones_subjetivo').val());
	var txt_observaciones_rxfinal = str_encode($('#txt_observaciones_rxfinal').val());
	//alert($('#txt_observaciones_avsc').val()+' - '+$('#txt_observaciones_lensometria').val()+' - '+$('#txt_observaciones_queratometria').val()+' - '+$('#txt_observaciones_objetivo').val()+' - '+$('#txt_observaciones_subjetivo_2').val()+' - '+$('#txt_observaciones_cicloplejia').val())
	var txt_observaciones_avsc = str_encode($('#txt_observaciones_avsc').val());
	var txt_observaciones_lensometria = str_encode($('#txt_observaciones_lensometria').val());
	var txt_observaciones_queratometria = str_encode($('#txt_observaciones_queratometria').val());
	var txt_observaciones_objetivo = str_encode($('#txt_observaciones_objetivo').val());
	var txt_observaciones_subjetivo_2 = str_encode($('#txt_observaciones_subjetivo_2').val());
	var txt_observaciones_cicloplejia = str_encode($('#txt_observaciones_cicloplejia').val());
	var txt_observaciones_rxfinal_2 = str_encode($('#txt_observaciones_rxfinal_2').val());
	var txt_observaciones_pin = str_encode($('#txt_observaciones_pin').val());
	...
	var observaciones_optometricas_finales = str_encode($('#observaciones_optometricas_finales').val());
	...
	params=params+'&hdd_id_hc_consulta='+ hdd_id_hc_consulta +
				  ...
				  '&cicloplejio_cerca_od=' + cicloplejio_cerca_od +
				  ...
				  '&cicloplejio_cerca_oi=' + cicloplejio_cerca_oi +
