                ...
                <div class="tabs-container">
                    <dl class="tabs" data-tab>
                        ...
                        <?php
								...
								case "4": //Pterigio 
						?>
                        <dd id="panel_oft_6" onclick="setTimeout(function() { ajustar_textareas(); }, 100);"><a href="#panel2-6">Pterigio  ( Opción en Desarrollo )</a></dd>
                        <?php
									break;									
							}
                        	...
                        	if ($ind_optometria) {
						?>
                        <dd id="panel_oft_1" onclick="setTimeout(function() { ajustar_textareas(); }, 100);"><a href="#panel2-1">Optometr&iacute;a</a></dd>
                        <?php
							}
						?>
                    </dl>
                    <div class="tabs-content no-margin no-padding">
                        ...
                        <div class="content" id="panel2-1">
                            <div id='div_consulta_optometria' style="height:<?php echo($alto_frame); ?>px;"></div>
                            <?php
								$id_menu_aux = "13";
                        ...
                        <div class="content active" id="panel2-2">
                            ...
                            <table border="0" cellpadding="1" cellspacing="0" align="center" style="width:98%;">
                                ...
                                <tr>
                                    <td align="center" colspan="2">
                                        <label><b>Solicitud de Ex&aacute;menes Complementarios</b></label>
