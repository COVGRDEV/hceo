...
<head>
    ...
    <script type="text/javascript" src="evolucion_v1.20.js"></script>
...
<body onload="ajustar_textareas(); ocultar_panels_evolucion();">
	<?php
            ...
            <form id="frm_consulta_evolucion" name="frm_consulta_evolucion" method="post">
                ...
                <div class="tabs-container">
                    <dl class="tabs" data-tab>
                        <dd id="panel_oft_3" onclick="setTimeout(function() { ajustar_textareas(); }, 100);"><a href="#panel2-3">Antecedentes</a></dd>
                        <dd id="panel_oft_2" class="active" onclick="setTimeout(function() { ajustar_textareas(); }, 100);"><a href="#panel2-2">Evoluci&oacute;n</a></dd>
                        <dd id="panel_oft_8" onclick="setTimeout(function() { ajustar_textareas(); }, 100);"><a href="#panel2-8">Incapacidades</a></dd>
                        <?php
							switch ($tipo_reg_adicional) {
								case "2": //Retina
						?>
                        <dd id="panel_oft_4" onclick="setTimeout(function() { ajustar_textareas(); }, 100);"><a href="#panel2-4">Retina</a></dd>
                        <?php
									break;
								case "3": //Oculoplastia
						?>
                        <dd id="panel_oft_5" onclick="setTimeout(function() { ajustar_textareas(); }, 100);"><a href="#panel2-5">Oculoplastia</a></dd>
                        <?php
									break;
								case "4": //Pterigio
						?>
                        <dd id="panel_oft_6" onclick="setTimeout(function() { ajustar_textareas(); }, 100);"><a href="#panel2-6">Pterigio</a></dd>
                        <?php
									break;
								case "5": //NESO
						?>
                        <dd id="panel_oft_7" onclick="setTimeout(function() { ajustar_textareas(); }, 100);"><a href="#panel2-7">NESO</a></dd>
                        <?php
									break;
							}
                        	...
                        	if ($ind_optometria) {
						?>
                        <dd id="panel_oft_1" onclick="setTimeout(function() { ajustar_textareas(); ajustar_div_optometria(); }, 100);"><a href="#panel2-1">Optometr&iacute;a</a></dd>
                        <?php
							}
						?>
                    </dl>
                    <div class="tabs-content no-margin no-padding">
                        ...
                        <div class="content active" id="panel2-2">
                            ...
                            <table border="0" cellpadding="1" cellspacing="0" align="center" style="width:98%;">
                                ...
                                <tr>
                                    <td align="center" colspan="2">
                                		...
                                		<?php
											...
											if($id_hc >= "443440" && strpos(trim(strip_tags($solicitud_examenes_evolucion),""),substr($mensaje_HC["valor_variable"], 0, 10)) === 0 || ($id_hc < "443440" && $id_hc > 0) || ($id_hc == 0 && strpos(trim(strip_tags($solicitud_examenes_evolucion),""),substr($mensaje_HC["valor_variable"], 0, 10)) === 0)){
										?>		
										...
										?>
                                				<div id="txt_solicitud_examenes_evolucion"><?php echo("<b>".$mensaje_HC["valor_variable"]."</b>"."<br><br>".$utilidades->ajustar_texto_wysiwyg(                                                $solicitud_examenes_evolucion)) ?></div>
                           			 <?php 
										}
										?>  
                                ...
                                <tr>
                                <!--SE AÑADE EL MENSAJE DE HISTORIA CLINICA -->
                                    <td align="center" colspan="2">
    ...
    <script>
		...
		initCKEditorEvolucion("txt_desc_antecedentes_medicos");
