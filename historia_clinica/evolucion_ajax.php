		...
		case "1": //Guardar Consulta de Evolución
			...
			if ($resultado > 0) {
				$resultado = $dbConsultaEvolucion->editar_consulta_evolucion($id_hc, $id_admision, $texto_evolucion, $array_diagnosticos, $diagnostico_evolucion,
						...
						$ind_formula_gafas, $array_antecedentes_medicos_ids, $array_antecedentes_medicos_val, $desc_antecedentes_medicos, $ind_antec_cx_refrac,
						$array_tonometria, $observaciones_tonometria);
			}
