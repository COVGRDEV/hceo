...
function editar_consulta_evolucion(tipo) {
	...
	//var diagnostico_evolucion  = str_encode($('#txt_diagnostico_evolucion').val()); 
	var diagnostico_evolucion = str_encode(CKEDITOR.instances.txt_diagnostico_evolucion.getData());
	//var solicitud_examenes_evolucion = str_encode($('#txt_solicitud_examenes_evolucion').val());
	var solicitud_examenes_evolucion = str_encode(CKEDITOR.instances.txt_solicitud_examenes_evolucion.getData());
	//var tratamiento_evolucion = str_encode($('#txt_tratamiento_evolucion').val());
