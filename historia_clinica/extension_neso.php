<?php
	...
	function getFormularioLesionNeso($consecutivo_frm, $registro_neso, $id_ojo_nuevo_registro=null) {
		...
		<div>
			<tr>					
				<td>
				<input type="hidden" name="neso_hdd_idojo_<?php echo $i?>" id="neso_hdd_idojo_<?php echo $i?>" value="<?php echo $neso_idojo;?>">
				<label><input type="text" name="neso_nhusos_<?php echo $i?>" id="neso_nhusos_<?php echo $i?>" value="<?php echo $neso_nhusos;?>" maxlength="2" class="input input_hc" onkeypress="return solo_numeros(event, false);" style="display:inline"></label></td> 
				<!--<td><label><input type="checkbox" id="neso_huso1_od" name="neso_huso1_od" value="1" <?php if ($neso_huso1_od=="1") echo "checked";?>/>I</label></td> -->
				<td>
				<?php
					$combo->getComboDb("neso_husoini_".$i, $neso_husoini, $lista_husos, "codigo_detalle, nombre_detalle", "--Seleccione--", "", 1, "width:120px", "", "select_hc no-margin");
				?>						
				</td>
				<td><label><input type="text" name="neso_mmcornea_<?php echo $i?>" id="neso_mmcornea_<?php echo $i?>" value="<?php echo $neso_mm;?>" maxlength="2" class="input input_hc" onkeypress="return solo_numeros(event, false);" style="display:inline"> mm</label></td>
			</tr>			
		</div>
		<?php 	
	}					
...
<table border="0" cellpadding="3" cellspacing="0" align="center" style="width:98%;">
    ...
    <tr>
        ...
        <td><label><span id="label_husos">&nbsp; Husos horarios<br>comprometidos* &nbsp;</span></label></td>
		<td>
    ...
    <tr>
		...
		<!--<td align="center" style="width:100%;">-->
		<td align="center">
			<!--<img src="../imagenes/husos_neso.png" width="300" height="249">-->
			<?php		
			$params = "&id_paciente=".$id_paciente.
    ...
    <tr>
        ...
        <td><label>Lesi&oacute;n recidivante*</label></td>
		<td>
			<?php				
