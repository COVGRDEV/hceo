...
function validar_check(opcion){
	switch(opcion){
		case 0:
			 if(!$('#ind_habeas_1').prop('disabled')){
				 $("#ind_habeas_1" ).prop( "disabled", true );
				 $("#ind_habeas_1").removeAttr('checked');
			 }else{
				  $( "#ind_habeas_1" ).prop( "disabled", false );
			 } 
		break;
		case 1:
			 if(!$('#ind_habeas_0').prop('disabled')){
				 $( "#ind_habeas_0" ).prop( "disabled", true );
				 $("#ind_habeas_0").removeAttr('checked');
			 }else{
				  $( "#ind_habeas_0" ).prop( "disabled", false );
			 }
		break;
	}
}