    ...
    <body>
        ...
        <div class="contenedor_principal volumen">
            <div class="padding">
				...
				<fieldset style="text-align: left;">
                    <legend>Reporte Coomeva MP</legend>
                    <table style="width: 100%;">
                        <tr>
                            <td align="right" style="width:15%;">
                                <label>Fecha inicial&nbsp;:&nbsp;</label>                            
                            ...
                            <td align="left" style="width:35%;">
                                <input type="text" class="input" maxlength="10" style="width:120px;" name="txt_fecha_ini_coomeva" id="txt_fecha_ini_coomeva" onkeyup="DateFormat(this, this.value, event, false, '3');" onfocus="vDateType = '3';" onBlur="DateFormat(this, this.value, event, true, '3');" tabindex="" />
                            </td>
                            <td align="right" style="width:15%;">
                                <label>Fecha final&nbsp;:&nbsp;</label>
                            </td>
                            <td align="left" style="width:35%;">
                                <input type="text" class="input" maxlength="10" style="width:120px;" name="txt_fecha_fin_coomeva" id="txt_fecha_fin_coomeva" onkeyup="DateFormat(this, this.value, event, false, '3');" onfocus="vDateType = '3';" onBlur="DateFormat(this, this.value, event, true, '3');" tabindex="" />
                            </td>
                        ...
                        <tr>
                            ...
                            <td align="left">
                                <?php
									$lista_convenios_aux = $convenios->getListaConveniosActivos();
									$combo->getComboDb("cmb_convenio_coomeva", 13, $lista_convenios_aux, "id_convenio, nombre_convenio", "--Seleccione el convenio--", "", "", "width:250px;");
								?>
                            </td>
                           <td colspan="2" align="center">
                            	<!--<input type="button" id="btn_generar_reporte_coomeva" name="btn_generar_reporte_coomeva" class="btnPrincipal" value="Generar PDF" onclick="generar_reporte_coomeva();" />-->
                                &nbsp;&nbsp;
                                <input type="button" id="btn_generar_reporte_coomeva_excel" name="btn_generar_reporte_coomeva_excel" class="btnPrincipal" 
                                value="Generar Excel" onclick="generar_reporte_coomeva_excel();" />
                                
                            </td>
                        </tr>
                    </table>
                    <form id="frm_reporte_coomeva" name="frm_reporte_coomeva" action="reporte_oportunidad_excel.php" method="post" style="display:none;" target="_blank"> 
                        <input type="hidden" id="hdd_fecha_inicial_coomeva" name="hdd_fecha_inicial_coomeva" />
                        <input type="hidden" id="hdd_fecha_final_coomeva" name="hdd_fecha_final_coomeva" />
                        <input type="hidden" id="hdd_convenio_coomeva" name="hdd_convenio_coomeva" />
        ...
        <script>
			...
			$(function() {
				...
				$("#txt_fecha_ini_coomeva").fdatepicker({
					format: "dd/mm/yyyy"
				});
				$("#txt_fecha_fin_coomeva").fdatepicker({
					format: "dd/mm/yyyy"
				});
			});
        </script>
