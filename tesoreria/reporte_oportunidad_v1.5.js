...
// funcion agregada para la seleción del convenio y plan
...
function generar_reporte_coomeva() {
	var fecha_inicial = $("#txt_fecha_ini_coomeva").val();
	var fecha_final = $("#txt_fecha_fin_coomeva").val();
	...
	var params = "opcion=4&fecha_inicial=" + fecha_inicial +
...
function generar_reporte_coomeva_excel() {
	var fecha_inicial = $("#txt_fecha_ini_coomeva").val();
	var fecha_final = $("#txt_fecha_fin_coomeva").val();
	var convenio = $("#cmb_convenio_coomeva").val();
	
	if (fecha_inicial == "" || fecha_final == "") {
		alert("Debe ingresar un rango de fechas");
		return;
	}
	$("#hdd_fecha_inicial_coomeva").val(fecha_inicial);
	$("#hdd_fecha_final_coomeva").val(fecha_final);
	
	if (convenio == "") {
			convenio = 0;
		}
	$("#hdd_convenio_coomeva").val(convenio);
		
	
	//Enviar los datos del formulario
	if (isObject(document.getElementById("frm_reporte_coomeva"))) {
