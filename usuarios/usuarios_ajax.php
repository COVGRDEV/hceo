...
switch ($opcion) {
            ...
            <table border="0" cellpadding="5" cellspacing="0" align="center" style="width:52em;">
                ...
                ?>
                    ...
                    <tr valign="top">
                        ...
                        <td align="left">
                            <input type="password" class="input" value="" name="txt_clave" id="txt_clave" maxlength="50" size="20" onblur="convertirAMinusculas(this); trim_cadena(this);" />
                        </td>
                    </tr>
                    <?php
    ...
    case "4": //Opcion para crear nuevo usuarios
		...
		$resultado = $dbUsuarios->crearUsuario($txt_nombre_usuario, $txt_apellido_usuario, $cmb_tipo_documento, $txt_numero_documento, $id_usuario_firma,
				$cmb_tipo_num_reg, $txt_num_reg_medico, "", $txt_usuario, $txt_clave, $ind_anonimo, $ind_autoriza, $perfiles_usuarios, $id_usuario_crea);
    ...
    case "6": //Opcion para editar nuevo usuarios
		...
		$msg_resultado = $dbUsuarios->editarUsuario($hdd_id_usuario, $txt_nombre_usuario, $txt_apellido_usuario, $cmb_tipo_documento, $txt_numero_documento,
				$id_usuario_firma, $cmb_tipo_num_reg, $txt_num_reg_medico, $nombre_arch, $ind_anonimo, $check_estado, $perfiles_usuarios, $id_usuario_crea, $ind_autoriza);
	?>
	<script id="ajax" type="text/javascript">
